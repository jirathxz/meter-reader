...
[![Version v4.1](https://img.shields.io/badge/Release-v4.1-blue.svg)](https://github.com/jirathxz/meter-reader/releases/tag/v4.1)
...
|---|:---:|:---:|---|
| **Exact Reading Accuracy (100% Match)** | **70.0%** (84/120)<br>*(Baseline: 67.5%)* | [61.3%, 77.5%] | สัดส่วนภาพที่อ่านค่าตรงกับเฉลยครบทุกหลัก 100% (กู้คืนสำเร็จ +3 ภาพด้วย Col-NMS) |
| **Wheel-Roll Tolerance Accuracy (±1)** | **76.7%** (92/120) | [68.3%, 83.3%] | ยอมรับความคลาดเคลื่อน ±1 บนลูกล้อหมุนกึ่งรอบในหลักทศนิยมสุดท้าย |
| **Operational Billing Accuracy (m³)** | **73.3%** (88/120) | [64.8%, 80.4%] | สัดส่วนภาพที่ตัวเลขส่วนจำนวนเต็มลูกบาศก์เมตรถูกต้องสมบูรณ์สำหรับจัดทำบิล |
| **Digit-level Accuracy** | **88.0%** (828/941) | [85.8%, 89.9%] | สัดส่วนตำแหน่งตัวเลขที่ทำนายถูกต้องต่อจำนวนหลักทั้งหมด |
| **Digit Error Rate (DER)** | **9.25%** (0.0925) | - | อัตราความผิดพลาด คำนวณจาก $(S+D+I)/N_{\text{ref}}$ |
| **Mean Model Confidence** | **0.8577** | [0.798, 0.895] | ค่าความเชื่อมั่นเฉลี่ยของกล่องตัวเลขจากแบบจำลอง YOLO |
| **Reading Success Rate** | **100.0%** (120/120) | [96.9%, 100.0%] | สัดส่วนภาพที่ระบบส่งคืนผลลัพธ์โดยไม่ล้มเหลว |
| **เวลาประมวลผลเฉลี่ย (CPU)** | **533.2 ms ต่อภาพ** (Single-pass)<br>**2,171.6 ms ต่อภาพ** (Multi-pass) | [490.2, 661.0] ms | วัดบน CPU AMD Ryzen 5 8645HS ที่ความละเอียด 960x960 |
...
*กรณีไม่ใช่ภาพมาตรวัดน้ำ:* คืนค่า `"success": false`, `"reading": ""` และ `"meter_check": {"verified": false, ...}` พร้อมคำเตือน `"ภาพนี้ไม่ใช่มิเตอร์น้ำ (predicted_class)"`

---

## เอกสารคู่มือฉบับเต็มและงานวิจัยที่เกี่ยวข้อง (Documentation)

* **คู่มือการพัฒนาระบบและรายงานวิจัยฉบับสมบูรณ์ (v3.2):** [TUTORIAL.md](file:///d:/_Work/Guidebook-RE/meter-reader/TUTORIAL.md)
