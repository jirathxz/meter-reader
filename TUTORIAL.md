...
&emsp;&emsp;คู่มือฉบับนี้จัดทำขึ้นสำหรับนักศึกษา นักพัฒนาซอฟต์แวร์ และผู้เริ่มต้นศึกษาด้านคอมพิวเตอร์วิทัศน์ที่มีพื้นฐานภาษา Python เพื่อใช้เป็นแนวทางในการเรียนรู้และพัฒนาระบบอ่านค่ามาตรวัดน้ำอัตโนมัติ (Water Meter OCR) ด้วยสถาปัตยกรรม **Python 3.11, YOLO26, SigLIP2, OpenCV, FastAPI และ Gradio** จัดการสภาพแวดล้อมด้วย **uv** โดยระบบถูกออกแบบโดยแบ่งการทำงานออกเป็นฟังก์ชันย่อยตามหน้าที่อย่างเป็นลำดับ เพื่อให้แต่ละขั้นตอนเข้าใจง่าย ทดสอบง่าย และแก้ไขแยกจากกันได้
...
5. **โครงสร้างโค้ดแบบฟังก์ชันเดี่ยว:** โค้ดในโปรเจกต์นี้เขียนเรียงจากบนลงล่างอย่างตรงไปตรงมา แต่ละฟังก์ชันรับภาพเข้ามา ประมวลผล และส่งผลลัพธ์ต่อไปยังฟังก์ชันถัดไป ทำให้อ่านทำความเข้าใจและดีบักได้ง่าย
...
* **ปัญหา:** เมื่อตรวจจับตัวเลขบนภาพที่หมุน 90° พิกัดสี่เหลี่ยมจะอยู่ในแกนของภาพหมุน หากนำไปวาดบนภาพเดิม พิกัดจะเพี้ยน
* **วิธีแก้:** แปลงพิกัดจุด $(x, y)$ ทีละจุดย้อนกลับตามมุมหมุน แล้วหาค่า `min/max` เพื่อสร้าง Bounding Box บนภาพต้นฉบับ
...
* **ปัญหา:** ไม่สามารถรู้ล่วงหน้าได้ว่าภาพถ่ายจะเอียงมุมไหน หรือใช้ฟิลเตอร์แบบใดถึงจะชัดที่สุด
* **แนวคิด:** ทดลองนำภาพไปหมุน 4 ทิศ (0°, 90°, 180°, 270°) × ปรับแสง 3 แบบ (Orig, CLAHE, HistEq) รวมเป็น 12 รูปแบบ แล้วคำนวณคะแนนเลือกรูปแบบที่ได้คะแนนสูงสุด
* **กฎสีแดงของหลักทศนิยม (`red_ratio`):** หลักทศนิยมสีแดงต้องอยู่ **ขวาสุด** ของหน้าปัดเสมอ หากพบสีแดงอยู่ทางซ้าย แสดงว่าภาพกำลังกลับหัว จะถูกตัดคะแนนลงครึ่งหนึ่ง
* **Margin Rule:** มุมอื่นต้องชนะมุมตั้งต้น (0°) เกิน `0.12` คะแนน ถึงจะยอมเปลี่ยนมุม เพื่อกันการสลับมุมเมื่อคะแนนสูสี
