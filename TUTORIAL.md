...
4.2.1 ประสิทธิผลของการค้นหา 12 สมมติฐานและการประมวลผลภาพ (ตอบ RQ2): การค้นหาเชิงครอบคลุม (4 ทิศทาง × 3 การปรับแสง) มีบทบาทสำคัญในการแก้ไขปัญหาภาพเอียงและสภาพแสงไม่เอื้ออำนวย โดยเพิ่มอัตราความถูกต้องของการอ่านค่าจาก $42.86\%$ ใน Single-pass Baseline สู่ $71.43\%$ ในระยะ M2 อย่างไรก็ตาม ผลการทดลองชี้ให้เห็นชัดเจนถึงข้อแลกเปลี่ยน (Trade-off) ด้านเวลา โดย Latency เพิ่มขึ้นจาก $421.1$ ms เป็น $5,492.6$ ms บน CPU เนื่องจากต้องรัน Inference ซ้ำ 12 ครั้ง<br>
