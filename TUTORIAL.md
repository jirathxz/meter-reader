...
&emsp;&emsp;&emsp;&emsp;ดังภาพที่ 1.2 แสดงแผนภาพการไหลของข้อมูลและการทำงานของระบบตั้งแต่ต้นน้ำจนถึงปลายน้ำ
...
flowchart LR
  ...
  subgraph Screening ["ขั้นตอนที่ 2: การคัดกรองประเภทมาตรวัด"]
    C -->|"ไฟล์สมบูรณ์"| D["🔍 SigLIP2 Verification<br/>(Zero-shot 4 คลาส)"]
    D --> E{"เป็นภาพมาตรวัดน้ำ<br/>Confidence ≥ 0.50?"}
    E -->|"ไม่ใช่"| E1["⚠️ แจ้งเตือน:<br/>ไม่ใช่มาตรวัดน้ำ"]
  end

  subgraph Processing ["ขั้นตอนที่ 3-4: การค้นหา 12 รูปแบบและแปลงพิกัด"]
    E -->|"ใช่"| F["⚙️ Multi-hypothesis Search<br/>4 ทิศ × 3 ฟิลเตอร์ (12 รูปแบบ)"]
    F --> G["🎯 YOLO26 ตรวจจับตัวเลข 0-9<br/>+ ตัดกรอบซ้อน (IoU Dedup)"]
    G --> H["📐 ตรวจกรองแถวตั้ง (is_vertical)<br/>+ คำนวณคะแนนและกฎ Margin"]
    H --> I["🔄 แปลงพิกัดกล่องกลับภาพเดิม<br/>(remap_bbox)"]
  end

  subgraph Safety ["ขั้นตอนที่ 5-6: ความปลอดภัยและการส่งออกผลลัพธ์"]
    I --> J["🛡️ Safety Guards Verification<br/>• ตรวจกลับหัว 180° (flip_guard)<br/>• ตรวจทานความเชื่อมั่นต่ำ (SigLIP2)<br/>• ตรวจแนวแถวและทศนิยมแดง"]
...
<p align="center"><strong>ภาพที่ 1.2: แผนภาพการทำงานของระบบ (Pipeline Data Flow)</strong></p>
