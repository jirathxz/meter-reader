...
&emsp;&emsp;&emsp;&emsp;สถาปัตยกรรมของ YOLO26 ประกอบด้วย 3 ส่วนหลัก ได้แก่:<br>
1.6.2.1 โครงข่ายหลักสกัดคุณลักษณะ (Backbone Network - CSPDarknet): ทำหน้าที่สกัดคุณลักษณะของภาพ (Feature Extraction) ในระดับความละเอียดต่างๆ ตั้งแต่เส้นขอบ พื้นผิว จนถึงรูปร่างของตัวเลข<br>
1.6.2.2 โครงข่ายคอ (Neck Network - PAN-FPN): ทำหน้าที่ผสานคุณลักษณะจากระดับลึกและระดับตื้นเข้าด้วยกัน เพื่อรักษารายละเอียดของตัวเลขขนาดเล็กและบริบทภาพรวมของหน้าปัด<br>
1.6.2.3 ส่วนหัวตรวจจับ (Detection Head - Anchor-free Head): ทำหน้าที่ทำนายพิกัด Bounding Box ค่าความเชื่อมั่น และคลาสตัวเลข 0–9 โดยตรงจากแผนที่ฟีเจอร์
...
| สถาปัตยกรรมแบบจำลอง | จำนวนพารามิเตอร์ (Params) | ขนาดหน่วยความจำ VRAM โดยประมาณ | จุดเด่นเชิงทฤษฎี | ข้อจำกัดสำหรับการประยุกต์ใช้ในงานนี้ | แหล่งอ้างอิงเอกสาร |
|---|---|---|---|---|---|
...
> [!NOTE]
> **ข้อจำกัดของข้อมูลในตารางที่ 1.1:** ตัวเลขจำนวนพารามิเตอร์และขนาด VRAM ในตารางข้างต้นเป็นค่าสังเกตและค่าอ้างอิงตามเอกสารเผยแพร่ของผู้พัฒนาและวรรณกรรมเดิม (Ultralytics, 2026; Ren et al., 2015; Smith, 2007) ซึ่งมีไว้เพื่อประกอบการตัดสินใจเลือกสถาปัตยกรรมเท่านั้น ทั้งนี้ตารางข้างต้นไม่ได้รวมเวลาประมวลผล (Latency) เนื่องจากสภาวะแวดล้อมในการทดสอบของแต่ละเอกสารมีความแตกต่างกันอย่างมาก (เช่น TensorRT vs PyTorch FP32 และขนาดภาพนำเข้า) โดยผลการวัดเวลาจริงของระบบปลายทางถึงปลายทางบนโปรเจกต์นี้ มีการรายงานอย่างละเอียดและควบคุมสภาวะแวดล้อมในหัวข้อ 3.4.7 โดยจำแนกเวลา Preprocessing, Inference, และ Postprocessing ภายใต้ฮาร์ดแวร์ที่ระบุชัดเจน
