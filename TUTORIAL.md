...
&emsp;[1.1 บทนำ ... 4](#11-บทนำ)  
&emsp;&emsp;[1.1.1 ความเป็นมาและความสำคัญของปัญหา ... 4](#111-ความเป็นมาและความสำคัญของปัญหา)  
&emsp;&emsp;[1.1.2 แนวคิดในการแก้ปัญหา ... 4](#112-แนวคิดในการแก้ปัญหา)  
&emsp;&emsp;[1.1.3 วัตถุประสงค์ของระบบ ... 4](#113-วัตถุประสงค์ของระบบ)  
&emsp;&emsp;[1.1.4 ขอบเขตการศึกษา ... 5](#114-ขอบเขตการศึกษา)  
&emsp;&emsp;[1.1.5 ผลที่คาดว่าจะได้รับ ... 5](#115-ผลที่คาดว่าจะได้รับ)  
&emsp;&emsp;[1.1.6 ระยะเวลาดำเนินงาน ... 5](#116-ระยะเวลาดำเนินงาน)  
&emsp;[1.2 ระบบงานเดิมและระบบงานที่เกี่ยวข้อง ... 6](#12-ระบบงานเดิมและระบบงานที่เกี่ยวข้อง)  
&emsp;&emsp;[1.2.1 ระบบงานเดิม ... 6](#121-ระบบงานเดิม)  
&emsp;&emsp;[1.2.2 ระบบงานอื่นที่เกี่ยวข้อง ... 6](#122-ระบบงานอื่นที่เกี่ยวข้อง)  
&emsp;[1.3 องค์ความรู้ที่เกี่ยวข้อง ... 7](#13-องค์ความรู้ที่เกี่ยวข้อง)  
&emsp;&emsp;[1.3.1 คอมพิวเตอร์วิทัศน์และการตรวจจับวัตถุ ... 7](#131-คอมพิวเตอร์วิทัศน์และการตรวจจับวัตถุ)  
&emsp;&emsp;[1.3.2 การประมวลผลภาพดิจิทัล ... 7](#132-การประมวลผลภาพดิจิทัล)  
&emsp;&emsp;[1.3.3 เทคโนโลยี YOLO26 ... 7](#133-เทคโนโลยี-yolo26)  
&emsp;&emsp;[1.3.4 เทคโนโลยี SigLIP2 ... 7](#134-เทคโนโลยี-siglip2)  
&emsp;&emsp;[1.3.5 เทคโนโลยี OpenCV ... 8](#135-เทคโนโลยี-opencv)  
&emsp;&emsp;[1.3.6 ภาพรวมเทคโนโลยีและตาราง Library ... 8](#136-ภาพรวมเทคโนโลยีและตาราง-library)  
&emsp;[1.4 ภาพรวมกระบวนการทำงานและ User Flow ... 9](#14-ภาพรวมกระบวนการทำงานและ-user-flow)  
&emsp;[1.5 การรับภาพถ่ายนำเข้า ... 9](#15-การรับภาพถ่ายนำเข้า)  
&emsp;[1.6 การเตรียมชุดข้อมูลและการฝึกแบบจำลอง YOLO ... 10](#16-การเตรียมชุดข้อมูลและการฝึกแบบจำลอง-yolo)  
&emsp;&emsp;[1.6.1 การเตรียมชุดข้อมูลจาก Roboflow ... 10](#161-การเตรียมชุดข้อมูลจาก-roboflow)  
&emsp;&emsp;[1.6.2 การฝึกแบบจำลอง YOLO26 ... 10](#162-การฝึกแบบจำลอง-yolo26)  
&emsp;[1.7 การคัดกรองภาพด้วย SigLIP2 ... 11](#17-การคัดกรองภาพด้วย-siglip2)  
&emsp;[1.8 การปรับปรุงคุณภาพภาพและการจัดการทิศทาง ... 11](#18-การปรับปรุงคุณภาพภาพและการจัดการทิศทาง)  
&emsp;[1.9 การแปลงพิกัดและการกรองข้อมูล ... 11](#19-การแปลงพิกัดและการกรองข้อมูล)  
&emsp;&emsp;[1.9.1 การหมุนภาพและการปรับปรุงคุณภาพภาพ ... 11](#191-การหมุนภาพและการปรับปรุงคุณภาพภาพ)  
&emsp;&emsp;[1.9.2 การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต ... 12](#192-การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต)  
&emsp;&emsp;[1.9.3 การกรองแถวแนวตั้งและการตรวจสอบสีแดง ... 12](#193-การกรองแถวแนวตั้งและการตรวจสอบสีแดง)  
&emsp;[1.10 การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม ... 12](#110-การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม)  
&emsp;[1.11 กลไกความปลอดภัยและการบอกค่าตัวเลข ... 13](#111-กลไกความปลอดภัยและการบอกค่าตัวเลข)  
&emsp;&emsp;[1.11.1 การตรวจจับภาพกลับหัวด้วย flip_guard ... 13](#1111-การตรวจจับภาพกลับหัวด้วย-flip_guard)  
&emsp;&emsp;[1.11.2 ฟังก์ชันประมวลผลหลัก read_meter ... 13](#1112-ฟังก์ชันประมวลผลหลัก-read_meter)  
[บทที่ 2 การพัฒนาแอปพลิเคชันและส่วนติดต่อผู้ใช้ ... 14](#บทที่-2-การพัฒนาแอปพลิเคชันและส่วนติดต่อผู้ใช้)  
&emsp;[2.1 เทคโนโลยีส่วนแอปพลิเคชันและส่วนติดต่อผู้ใช้ ... 14](#21-เทคโนโลยีส่วนแอปพลิเคชันและส่วนติดต่อผู้ใช้)  
&emsp;&emsp;[2.1.1 เทคโนโลยี FastAPI ... 14](#211-เทคโนโลยี-fastapi)  
&emsp;&emsp;[2.1.2 เทคโนโลยี Gradio ... 14](#212-เทคโนโลยี-gradio)  
&emsp;[2.2 การจัดเตรียมสภาพแวดล้อมและโครงสร้างไฟล์ด้วย uv ... 14](#22-การจัดเตรียมสภาพแวดล้อมและโครงสร้างไฟล์ด้วย-uv)  
&emsp;[2.3 การทดสอบไลบรารีเบื้องต้นก่อนลงมือจริง ... 15](#23-การทดสอบไลบรารีเบื้องต้นก่อนลงมือจริง)  
&emsp;&emsp;[2.3.1 ทดสอบ SigLIP2 ... 15](#231-ทดสอบ-siglip2)  
&emsp;&emsp;[2.3.2 ทดสอบ YOLO ... 15](#232-ทดสอบ-yolo)  
&emsp;&emsp;[2.3.3 ทดสอบ OpenCV ... 15](#233-ทดสอบ-opencv)  
&emsp;&emsp;[2.3.4 ทดสอบ FastAPI ... 15](#234-ทดสอบ-fastapi)  
&emsp;&emsp;[2.3.5 ทดสอบ Gradio ... 15](#235-ทดสอบ-gradio)  
&emsp;[2.4 การให้บริการระบบผ่าน FastAPI ... 16](#24-การให้บริการระบบผ่าน-fastapi)  
&emsp;[2.5 การพัฒนาส่วนติดต่อผู้ใช้ด้วย Gradio ... 16](#25-การพัฒนาส่วนติดต่อผู้ใช้ด้วย-gradio)  
&emsp;[2.6 การทดสอบระบบและการแก้ไขปัญหา ... 16](#26-การทดสอบระบบและการแก้ไขปัญหา)  
&emsp;&emsp;[2.6.1 วิธีการสั่งทำงานด้วย uv ... 16](#261-วิธีการสั่งทำงานด้วย-uv)  
&emsp;&emsp;[2.6.2 แนวทางการวิเคราะห์และแก้ไขปัญหา ... 16](#262-แนวทางการวิเคราะห์และแก้ไขปัญหา)  
[อภิธานศัพท์ (Glossary) ... 17](#อภิธานศัพท์-glossary)  
[บรรณานุกรมและเอกสารอ้างอิง (References) ... 18](#บรรณานุกรมและเอกสารอ้างอิง-references)  
[ภาคผนวก: มาตรการด้านความปลอดภัยและความเสถียรของระบบ ... 19](#ภาคผนวก-มาตรการด้านความปลอดภัยและความเสถียรของระบบ)  
...
### 1.2 ระบบงานเดิมและระบบงานที่เกี่ยวข้อง
...
#### 1.2.2 ระบบงานอื่นที่เกี่ยวข้อง
...
#### 1.3.1 คอมพิวเตอร์วิทัศน์และการตรวจจับวัตถุ
...
##### 1.3.2.2 Histogram Equalization (HistEq)
...
##### 1.3.3.2 เหตุผลที่เลือก YOLO26 Nano

&emsp;&emsp;&emsp;&emsp;โครงงานเลือก YOLO26 Nano (~2.6 ล้านพารามิเตอร์) เพราะ Nano ให้สมดุลระหว่างความแม่นยำและความเร็วที่เหมาะกับข้อจำกัดของงานมิเตอร์น้ำ ตารางที่ 1.2 เปรียบเทียบตัวเลือก

&emsp;&emsp;&emsp;&emsp;**ตารางที่ 1.2 เปรียบเทียบตัวเลือกแบบจำลองสำหรับตรวจจับเลขมิเตอร์**
...
&emsp;&emsp;&emsp;&emsp;**ตารางที่ 1.3 เปรียบเทียบ Softmax กับ Sigmoid**
...
##### 1.3.4.3 กระบวนการ Zero-shot 4 ขั้น
...
#### 1.3.6 ภาพรวมเทคโนโลยีและตาราง Library

&emsp;&emsp;&emsp;&emsp;ระบบสรุปเทคโนโลยีที่เลือกใช้และเหตุผลในตารางที่ 1.4 เพื่อให้ผู้อ่านเห็นภาพรวมในที่เดียว

&emsp;&emsp;&emsp;&emsp;**ตารางที่ 1.4 Library ทั้งหมดที่ใช้ — บทบาท — ทำไมเลือก**
...
<p align="center"><strong>ภาพที่ 1.1 User Flow ตั้งแต่ถ่ายภาพจนรับค่าตัวเลข</strong></p>
...
<p align="center"><strong>ภาพที่ 1.2 Pipeline ภายใน 12 รูปแบบและการเลือกผู้ชนะ</strong></p>

---

### 1.5 การรับภาพถ่ายนำเข้า
...
### 1.6 การเตรียมชุดข้อมูลและการฝึกแบบจำลอง YOLO
...
#### 1.6.1 การเตรียมชุดข้อมูลจาก Roboflow
...
### 1.8 การปรับปรุงคุณภาพภาพและการจัดการทิศทาง
...
### 1.9 การแปลงพิกัดและการกรองข้อมูล
...
#### 1.9.1 การหมุนภาพและการปรับปรุงคุณภาพภาพ
...
#### 1.9.2 การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต
...
#### 1.9.3 การกรองแถวแนวตั้งและการตรวจสอบสีแดง
...
### 1.10 การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม
...
##### 1.10.1 หมุน 4 ทิศ (0°/90°/180°/270°)

&emsp;&emsp;&emsp;&emsp;ระบบหมุน 4 ทิศเพื่อแก้ภาพเอียงหรือกลับหัว

##### 1.10.2 ปรับแสง 3 แบบ (Orig/CLAHE/HistEq)
...
##### 1.10.4 IoU dedup (threshold 0.45)
...
##### 1.10.6 red_ratio + Scoring

&emsp;&emsp;&emsp;&emsp;ระบบให้คะแนนตามตำแหน่งสีแดง

##### 1.10.7 Scoring (mean_conf × n)
...
### 1.11 กลไกความปลอดภัยและการบอกค่าตัวเลข
...
#### 1.11.1 การตรวจจับภาพกลับหัวด้วย flip_guard
...
#### 1.11.2 ฟังก์ชันประมวลผลหลัก read_meter
...
---
### 2.1 เทคโนโลยีส่วนแอปพลิเคชันและส่วนติดต่อผู้ใช้

&emsp;&emsp;&emsp;&emsp;บทนี้อธิบายเทคโนโลยีที่ใช้ในการพัฒนาแอปพลิเคชันและการสร้างส่วนติดต่อผู้ใช้สำหรับระบบอ่านค่ามาตรวัดน้ำ โดยมุ่งเน้นการให้บริการผ่านเว็บเซอร์วิสและการสร้างหน้าเว็บสำหรับทดสอบการใช้งาน

#### 2.1.1 เทคโนโลยี FastAPI
...
##### 2.1.1.1 FastAPI เทียบ Flask/Django
...
##### 2.1.2.1 Gradio เทียบ Streamlit
...
### 2.2 การจัดเตรียมสภาพแวดล้อมและโครงสร้างไฟล์ด้วย uv
...
### 2.3 การทดสอบไลบรารีเบื้องต้นก่อนลงมือจริง
...
#### 2.3.1 ทดสอบ SigLIP2 สำหรับ Image Classification
...
#### 2.3.2 ทดสอบ YOLO สำหรับ Object Detection
...
#### 2.3.3 ทดสอบ OpenCV สำหรับ Image Processing
...
#### 2.3.4 ทดสอบ FastAPI สำหรับสร้าง API
...
#### 2.3.5 ทดสอบ Gradio สำหรับสร้าง Web UI
...
### 2.4 การให้บริการระบบผ่าน FastAPI
...
### 2.5 การพัฒนาส่วนติดต่อผู้ใช้ด้วย Gradio
...
#### 2.6.2 แนวทางการวิเคราะห์และแก้ไขปัญหา
