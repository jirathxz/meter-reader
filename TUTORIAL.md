...
2. [บทที่ 1: ทฤษฎีพื้นฐาน เทคโนโลยีที่ใช้ และการประมวลผลภาพ](#บทที่-1-ทฤษฎีพื้นฐาน-เทคโนโลยีที่ใช้-และการประมวลผลภาพ)
  ...
  2.7 [1.6 ทฤษฎีและหลักการพื้นฐาน (Theory)](#17-ทฤษฎีและหลักการพื้นฐาน-theory)
    2.7.1 [1.6.1 คอมพิวเตอร์วิทัศน์และการรู้จำอักขระด้วยแสง (Computer Vision & OCR)](#171-คอมพิวเตอร์วิทัศน์และการรู้จำอักขระด้วยแสง-computer-vision--ocr)
    2.7.2 [1.6.2 แบบจำลองการตรวจจับวัตถุ YOLO (You Only Look Once)](#172-แบบจำลองการตรวจจับวัตถุ-yolo-you-only-look-once)
    2.7.3 [1.6.3 การจำแนกประเภทภาพแบบซีโร่ช็อตและแบบจำลองภาษา-ภาพ (Zero-shot Vision-Language Models)](#173-การจำแนกประเภทภาพแบบซีโร่ช็อตและแบบจำลองภาษา-ภาพ-zero-shot-vision-language-models)
    2.7.4 [1.6.4 ทฤษฎีการประมวลผลภาพดิจิทัลและปริภูมิสี (Digital Image Processing & Color Spaces)](#174-ทฤษฎีการประมวลผลภาพดิจิทัลและปริภูมิสี-digital-image-processing--color-spaces)
  2.8 [1.7 เทคนิคและอัลกอริทึมที่พัฒนาขึ้นในโครงงาน (Techniques)](#18-เทคนิคและอัลกอริทึมที่พัฒนาขึ้นในโครงงาน-techniques)
    2.8.1 [1.7.1 เทคนิคการคัดกรองภาพด้วย Zero-shot Classification (SigLIP2)](#181-เทคนิคการคัดกรองภาพด้วย-zero-shot-classification-siglip2)
    2.8.2 [1.7.2 เทคนิคการค้นหาเชิงสมมติฐานพหุคูณ 12 รูปแบบ (Multi-hypothesis 12-Combination Search)](#182-เทคนิคการค้นหาเชิงสมมติฐานพหุคูณ-12-รูปแบบ-multi-hypothesis-12-combination-search)
    2.8.3 [1.7.3 เทคนิคการตัดกรอบสี่เหลี่ยมซ้ำซ้อนด้วย IoU (Candidate Deduplication)](#183-เทคนิคการตัดกรอบสี่เหลี่ยมซ้ำซ้อนด้วย-iou-candidate-deduplication)
    2.8.4 [1.7.4 เทคนิคการแปลงพิกัดเรขาคณิตย้อนกลับ (Coordinate Remapping)](#184-เทคนิคการแปลงพิกัดเรขาคณิตย้อนกลับ-coordinate-remapping)
    2.8.5 [1.7.5 เทคนิคการกรองเค้าโครงแถวตัวเลขแนวตั้ง (Geometric Layout Filtering)](#185-เทคนิคการกรองเค้าโครงแถวตัวเลขแนวตั้ง-geometric-layout-filtering)
    2.8.6 [1.7.6 เทคนิคกลไกความปลอดภัยและการตรวจทานความถูกต้อง (Safety Guards)](#186-เทคนิคกลไกความปลอดภัยและการตรวจทานความถูกต้อง-safety-guards)
  ...
  2.11 [1.10 การฝึกแบบจำลองสำหรับการตรวจจับตัวเลข](#111-การฝึกแบบจำลองสำหรับการตรวจจับตัวเลข)
    2.11.1 [1.10.1 การเตรียมชุดข้อมูลจาก Roboflow](#1111-การเตรียมชุดข้อมูลจาก-roboflow)
    2.11.2 [1.10.2 การฝึกแบบจำลอง YOLO บน Google Colab](#1112-การฝึกแบบจำลอง-yolo-บน-google-colab)
  2.12 [1.11 สภาพแวดล้อมและการจัดการโครงงานด้วย `uv`](#112-สภาพแวดล้อมและการจัดการโครงงานด้วย-uv)
    2.12.1 [1.11.1 โครงสร้างไฟล์ของระบบ](#1121-โครงสร้างไฟล์ของระบบ)
    2.12.2 [1.11.2 การสร้างสภาพแวดล้อมและการติดตั้งไลบรารี](#1122-การสร้างสภาพแวดล้อมและการติดตั้งไลบรารี)
  2.13 [1.12 การวิเคราะห์รหัสต้นฉบับการประมวลผลคอมพิวเตอร์วิทัศน์](#113-การวิเคราะห์รหัสต้นฉบับการประมวลผลคอมพิวเตอร์วิทัศน์)
    2.13.1 [1.12.1 การหมุนภาพและการปรับปรุงคุณภาพภาพ (rotate_image, apply_prep)](#1131-การหมุนภาพและการปรับปรุงคุณภาพภาพ-rotate_image-apply_prep)
    2.13.2 [1.12.2 การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต (remap_point, remap_bbox)](#1132-การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต-remap_point-remap_bbox)
    2.13.3 [1.12.3 การกรองแถวตัวเลขแนวตั้ง (is_vertical)](#1133-การกรองแถวตัวเลขแนวตั้ง-is_vertical)
    2.13.4 [1.12.4 การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม (detect_digits_best)](#1134-การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม-detect_digits_best)
