...
1.12.4.10 `red_ratio(img_bgr, bbox)` — ตรวจสีแดงของหลักทศนิยม:<br>
 1.12.4.11 ปัญหาที่แก้ไข: การตรวจสอบทิศทางของหน้าปัด — มาตรวัดน้ำกลไกทั่วไปมีหลักทศนิยมสีแดงอยู่ตำแหน่งขวาสุด หากตรวจพบสีแดงที่ตำแหน่งซ้ายสุด มีความเป็นไปได้สูงที่ภาพจะกลับหัว<br>
...
2. พิจารณาตามเกณฑ์ความเชื่อมั่นที่กำหนด (CONF_RELIABLE เท่ากับ 0.60)
   2.1 กรณีค่าความเชื่อมั่นตั้งแต่ 0.60 ขึ้นไป: ยอมรับผลลัพธ์เนื่องจากมีความน่าเชื่อถือสูง<br>
   2.2 กรณีค่าความเชื่อมั่นต่ำกว่า 0.60: ครอปภาพเฉพาะตัวเลขหลักดังกล่าวส่งให้แบบจำลอง SigLIP2 จำแนกซ้ำ
...
&emsp;&emsp;&emsp;&emsp;4.1.2.5 กลไกความปลอดภัยและการตรวจทาน (Safety Guards & SigLIP2): เสริม Flip Guard, Cross-check, และ SigLIP2 ช่วยสร้างกลไกตรวจสอบความถูกต้องโดยไม่สูญเสียความแม่นยำ<br>
