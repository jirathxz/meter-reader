...
&emsp;&emsp;&emsp;&emsp;**คอมพิวเตอร์วิทัศน์ (Computer Vision)** เป็นศาสตร์ที่มุ่งพัฒนาให้คอมพิวเตอร์สามารถวิเคราะห์และตีความข้อมูลจากภาพได้ ส่วน **OCR (Optical Character Recognition)** คือการเปลี่ยนตัวเลขในภาพให้เป็นข้อความที่เอาไปใช้งานต่อได้

&emsp;&emsp;&emsp;&emsp;โครงงานนี้ประยุกต์ใช้แบบจำลอง **YOLO (You Only Look Once)** ซึ่งเป็นแบบจำลองปัญญาประดิษฐ์สำหรับการตรวจจับวัตถุที่มีความเร็วระดับเวลาจริง (Real-time Object Detection) (สถาปัตยกรรม YOLO26/YOLOv8) — มาหาตำแหน่งตัวเลข 0–9 โดยมีคำศัพท์สำคัญ 3 รายการ ได้แก่:

* **Bounding Box (`bbox`):** กรอบสี่เหลี่ยม `[x1, y1, x2, y2]` ที่ระบุตำแหน่งของตัวเลขภายในภาพ
...
> เมื่อจบหัวข้อนี้ ผู้อ่านจะเข้าใจว่า YOLO ทำหน้าที่ตรวจจับตำแหน่งและจำแนกประเภทของตัวเลขแต่ละหลัก
