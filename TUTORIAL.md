...
1.6.2.4 ส่วนสกัดคุณลักษณะ (Feature Extraction Backbone): ทำหน้าที่สกัดคุณลักษณะของภาพในระดับความละเอียดต่าง ๆ ตั้งแต่เส้นขอบ พื้นผิว จนถึงรูปร่างของตัวเลข<br>
1.6.2.5 ส่วนรวมคุณลักษณะหลายระดับ (Multi-Scale Feature Fusion Neck): ทำหน้าที่ผสานคุณลักษณะจากระดับลึกและระดับตื้นเข้าด้วยกัน เพื่อรักษารายละเอียดของตัวเลขขนาดเล็กและบริบทภาพรวมของหน้าปัด<br>
1.6.2.6 ส่วนหัวตรวจจับ (Detection Head): ทำหน้าที่ทำนายพิกัด Bounding Box ค่าความเชื่อมั่น และคลาสตัวเลข 0–9 โดยตรงจากแผนที่ฟีเจอร์
