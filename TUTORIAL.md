...
[บทที่ 2: การพัฒนาระบบอ่านค่ามาตรวัดน้ำเชิงปฏิบัติ ... 9](#บทที่-2-การพัฒนาระบบอ่านค่ามาตรวัดน้ำเชิงปฏิบัติ)  
	...
	&emsp;[2.2 ขั้นตอนที่ 1: การรับภาพถ่ายนำเข้า ... 9](#22-ขั้นตอนที่-1-การรับภาพถ่ายนำเข้า)  
	&emsp;[2.3 ขั้นตอนที่ 2: การเตรียมชุดข้อมูลและการฝึกแบบจำลอง YOLO ... 10](#23-ขั้นตอนที่-2-การเตรียมชุดข้อมูลและการฝึกแบบจำลอง-yolo)  
		&emsp;&emsp;[2.3.1 การเตรียมชุดข้อมูลจาก Roboflow ... 10](#231-การเตรียมชุดข้อมูลจาก-roboflow)  
		&emsp;&emsp;[2.3.2 การฝึกแบบจำลอง YOLO26 ... 10](#232-การฝึกแบบจำลอง-yolo26)  
	&emsp;[2.4 ขั้นตอนที่ 3: การจัดเตรียมสภาพแวดล้อมและโครงสร้างไฟล์ด้วย uv ... 11](#24-ขั้นตอนที่-3-การจัดเตรียมสภาพแวดล้อมและโครงสร้างไฟล์ด้วย-uv)  
	&emsp;[2.5 ขั้นตอนที่ 4: การคัดกรองภาพด้วย SigLIP2 ... 11](#25-ขั้นตอนที่-4-การคัดกรองภาพด้วย-siglip2)  
	&emsp;[2.6 ขั้นตอนที่ 5: การปรับปรุงคุณภาพภาพและการจัดการทิศทาง ... 12](#26-ขั้นตอนที่-5-การปรับปรุงคุณภาพภาพและการจัดการทิศทาง)  
	&emsp;[2.7 ขั้นตอนที่ 6: การแปลงพิกัดและการกรองข้อมูล ... 12](#27-ขั้นตอนที่-6-การแปลงพิกัดและการกรองข้อมูล)  
		&emsp;&emsp;[2.7.1 การหมุนภาพและการปรับปรุงคุณภาพภาพ ... 12](#271-การหมุนภาพและการปรับปรุงคุณภาพภาพ)  
		&emsp;&emsp;[2.7.2 การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต ... 12](#272-การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต)  
		&emsp;&emsp;[2.7.3 การกรองแถวแนวตั้งและการตรวจสอบสีแดง ... 13](#273-การกรองแถวแนวตั้งและการตรวจสอบสีแดง)  
	&emsp;[2.8 ขั้นตอนที่ 7: การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม ... 13](#28-ขั้นตอนที่-7-การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม)  
	&emsp;[2.9 ขั้นตอนที่ 8: กลไกความปลอดภัยและการบอกค่าตัวเลข ... 13](#29-ขั้นตอนที่-8-กลไกความปลอดภัยและการบอกค่าตัวเลข)  
	&emsp;[2.10 การให้บริการระบบผ่าน FastAPI ... 14](#210-การให้บริการระบบผ่าน-fastapi)  
	&emsp;[2.11 การพัฒนาส่วนติดต่อผู้ใช้ด้วย Gradio ... 14](#211-การพัฒนาส่วนติดต่อผู้ใช้ด้วย-gradio)  
	&emsp;[2.12 การทดสอบระบบและการแก้ไขปัญหา ... 15](#212-การทดสอบระบบและการแก้ไขปัญหา)  
...
### 2.2 ขั้นตอนที่ 1: การรับภาพถ่ายนำเข้า
...
### 2.3 ขั้นตอนที่ 2: การเตรียมชุดข้อมูลและการฝึกแบบจำลอง YOLO

&emsp;&emsp;&emsp;&emsp;ระบบเตรียมชุดข้อมูลและฝึก YOLO บนคลาวด์เพื่อให้ได้ไฟล์ `weights/MeterOCR.pt` ผู้ศึกษาที่มีไฟล์พร้อมใช้ข้ามไปบทที่ 2.4 ได้ทันที

#### 2.3.1 การเตรียมชุดข้อมูลจาก Roboflow
...
### 2.4 ขั้นตอนที่ 3: การจัดเตรียมสภาพแวดล้อมและโครงสร้างไฟล์ด้วย uv
...
### 2.5 ขั้นตอนที่ 4: การคัดกรองภาพด้วย SigLIP2
...
### 2.6 ขั้นตอนที่ 5: การปรับปรุงคุณภาพภาพและการจัดการทิศทาง
...
### 2.7 ขั้นตอนที่ 6: การแปลงพิกัดและการกรองข้อมูล
...
#### 2.7.1 การหมุนภาพและการปรับปรุงคุณภาพภาพ
...
#### 2.7.2 การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต
...
#### 2.7.3 การกรองแถวแนวตั้งและการตรวจสอบสีแดง
...
### 2.8 ขั้นตอนที่ 7: การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม
...
##### 2.8.1 หมุน 4 ทิศ (0°/90°/180°/270°)

&emsp;&emsp;&emsp;&emsp;ระบบหมุน 4 ทิศเพื่อแก้ภาพเอียงหรือกลับหัว

##### 2.8.2 ปรับแสง 3 แบบ (Orig/CLAHE/HistEq)
...
##### 2.8.4 IoU dedup (threshold 0.45)
...
##### 2.8.6 red_ratio + Scoring

&emsp;&emsp;&emsp;&emsp;ระบบให้คะแนนตามตำแหน่งสีแดง

##### 2.8.7 Scoring (mean_conf × n)
...
### 2.9 ขั้นตอนที่ 8: กลไกความปลอดภัยและการบอกค่าตัวเลข
...
#### 2.9.1 การตรวจจับภาพกลับหัวด้วย flip_guard
...
#### 2.9.2 ฟังก์ชันประมวลผลหลัก read_meter
...
### 2.10 การให้บริการระบบผ่าน FastAPI
...
### 2.11 การพัฒนาส่วนติดต่อผู้ใช้ด้วย Gradio
...
#### 2.12.2 แนวทางการวิเคราะห์และแก้ไขปัญหา
