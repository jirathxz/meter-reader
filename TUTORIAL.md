...
4.3.1 ประสิทธิผลของการค้นหา 12 สมมติฐานและการประมวลผลภาพ (ตอบ RQ2): ผลการทดลองแสดงให้เห็นว่าการค้นหาเชิงครอบคลุม (4 ทิศทาง × 3 การปรับแสง) สัมพันธ์กับการเพิ่มขึ้นของ Exact Reading Accuracy จาก 42.86% ใน Single-pass Baseline (M0) สู่ 71.43% ในขั้นตอน M2 บนชุดภาพสาธิต อย่างไรก็ตาม ผลการทดลองชี้ให้เห็นชัดเจนถึงข้อแลกเปลี่ยน (Trade-off) ด้านเวลา โดยเวลาประมวลผลเฉลี่ยภายใต้โปรโตคอลการทดลองแบบตัดทอนบนชุดสาธิตภาคสนาม (Ablation Measurement Protocol บนภาพสาธิต 7 ภาพ ตามตารางที่ 4.5 และบันทึกใน `reviews/ablation.csv`) เพิ่มขึ้นจาก 421.1 ms ในขั้นตอน M0 (Single-pass Baseline: 0° เดี่ยว 1 สมมติฐาน) เป็น 5,492.6 ms ในขั้นตอน M2 (M2: 5,492.6 ms/image under the ablation measurement protocol เมื่อขยายการค้นหาเป็น 12 สมมติฐาน 4 มุมหมุน × 3 รูปแบบคอนทราสต์) และขยับสู่ 5,828.8 ms ในขั้นตอน M7 เมื่อเปิดใช้งานท่อประมวลผลสมบูรณ์ร่วมกับ SigLIP2 และโมดูลตรวจสอบความปลอดภัยครบวงจร (Primary Official Full Pipeline M7 ซึ่งสอดคล้องในเชิงขนาดกับเวลาประมวลผลมาตรฐานหลักสภาวะคงที่ ~5.83 วินาทีต่อภาพ) บน CPU เนื่องจากต้องรันการอนุมานซ้ำ 12 ครั้งร่วมกับโมดูลคัดกรองความปลอดภัย<br>
