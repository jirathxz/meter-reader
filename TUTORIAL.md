...
&emsp;&emsp;&emsp;&emsp;[1.6.1 คอมพิวเตอร์วิทัศน์และการรู้จำตัวเลขจากภาพ (Computer Vision & Digit Recognition)](#161-คอมพิวเตอร์วิทัศน์และการรู้จำตัวเลขจากภาพ-computer-vision--digit-recognition)  
...
#### 1.6.1 คอมพิวเตอร์วิทัศน์และการรู้จำตัวเลขจากภาพ (Computer Vision & Digit Recognition)
...
&emsp;&emsp;&emsp;&emsp;ในมิติของภารกิจ การอ่านค่าตัวเลขบนหน้าปัดมาตรวัดน้ำมีลักษณะที่เกี่ยวข้องกับการรู้จำอักขระจากภาพ (Optical Character Recognition: OCR) ทว่าในการนำไปประยุกต์ใช้จริง เทคโนโลยี OCR ดั้งเดิม (เช่น Tesseract) ที่มุ่งเน้นการรู้จำข้อความเอกสารทั่วไป มักเผชิญข้อจำกัดเมื่อภาพถ่ายในภาคสนามมีการเอียง แสงสะท้อนจ้า หรือคราบสกปรกบดบัง ในทางตรงกันข้าม การประยุกต์ใช้การตรวจจับวัตถุด้วยการเรียนรู้เชิงลึก (Deep Learning-based Object Detection) จะมองตัวเลขอารบิกแต่ละหลักเป็นวัตถุหนึ่งชิ้น ทำให้ implementation หลักของระบบสามารถตรวจจับตำแหน่ง (Localization) และรู้จำค่าตัวเลขแต่ละหลัก (Classification) ได้พร้อมกันโดยตรงจากภาพถ่ายเต็มเฟรมโดยไม่ต้องพึ่งพา OCR engine สำเร็จรูป
