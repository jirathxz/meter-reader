...
&emsp;&emsp;[1.6 ทฤษฎีและหลักการพื้นฐาน](#16-ทฤษฎีและหลักการพื้นฐาน)  
&emsp;&emsp;&emsp;&emsp;[1.6.1 คอมพิวเตอร์วิทัศน์และการรู้จำอักขระด้วยแสง (Computer Vision & OCR)](#161-คอมพิวเตอร์วิทัศน์และการรู้จำอักขระด้วยแสง-computer-vision-ocr)  
&emsp;&emsp;&emsp;&emsp;[1.6.2 แบบจำลองการตรวจจับวัตถุ YOLO](#162-แบบจำลองการตรวจจับวัตถุ-yolo)  
&emsp;&emsp;&emsp;&emsp;[1.6.3 การจำแนกประเภทภาพแบบ Zero-shot และแบบจำลองภาษา-ภาพ](#163-การจำแนกประเภทภาพแบบ-zero-shot-และแบบจำลองภาษา-ภาพ)  
&emsp;&emsp;&emsp;&emsp;[1.6.4 ทฤษฎีการประมวลผลภาพดิจิทัลและปริภูมิสี](#164-ทฤษฎีการประมวลผลภาพดิจิทัลและปริภูมิสี)  
&emsp;&emsp;[1.7 เทคนิคและอัลกอริทึมที่พัฒนาขึ้นในโครงงาน](#17-เทคนิคและอัลกอริทึมที่พัฒนาขึ้นในโครงงาน)  
&emsp;&emsp;&emsp;&emsp;[1.7.1 เทคนิคการคัดกรองภาพด้วย Zero-shot Classification (SigLIP2)](#171-เทคนิคการคัดกรองภาพด้วย-zero-shot-classification-siglip2)  
&emsp;&emsp;&emsp;&emsp;[1.7.2 เทคนิคการค้นหาเชิงสมมติฐานพหุคูณ 12 รูปแบบ](#172-เทคนิคการค้นหาเชิงสมมติฐานพหุคูณ-12-รูปแบบ)  
&emsp;&emsp;&emsp;&emsp;[1.7.3 เทคนิคการตัดกรอบสี่เหลี่ยมซ้ำซ้อนด้วย IoU](#173-เทคนิคการตัดกรอบสี่เหลี่ยมซ้ำซ้อนด้วย-iou)  
&emsp;&emsp;&emsp;&emsp;[1.7.4 เทคนิคการแปลงพิกัดเรขาคณิตย้อนกลับ](#174-เทคนิคการแปลงพิกัดเรขาคณิตย้อนกลับ)  
&emsp;&emsp;&emsp;&emsp;[1.7.5 เทคนิคการกรองเค้าโครงแถวตัวเลขแนวตั้ง](#175-เทคนิคการกรองเค้าโครงแถวตัวเลขแนวตั้ง)  
&emsp;&emsp;&emsp;&emsp;[1.7.6 เทคนิคกลไกความปลอดภัยและการตรวจทานความถูกต้อง](#176-เทคนิคกลไกความปลอดภัยและการตรวจทานความถูกต้อง)  
&emsp;&emsp;&emsp;&emsp;[1.7.7 เทคนิคการตรวจจับทิศทางข้อความและสัญลักษณ์หน่วย m บนหน้าปัดเพื่อจัดวางแนวระนาบ](#177-เทคนิคการตรวจจับทิศทางข้อความและสัญลักษณ์หน่วย-m-บนหน้าปัดเพื่อจัดวางแนวระนาบ)  
&emsp;&emsp;[1.8 เทคโนโลยี ชุดเครื่องมือ และไลบรารีที่ใช้ในโครงงาน](#18-เทคโนโลยี-ชุดเครื่องมือ-และไลบรารีที่ใช้ในโครงงาน)  
&emsp;&emsp;[1.9 ขั้นตอนและวิธีการทำงานของระบบ](#19-ขั้นตอนและวิธีการทำงานของระบบ)  
&emsp;&emsp;[1.10 การฝึกแบบจำลองสำหรับการตรวจจับตัวเลข](#110-การฝึกแบบจำลองสำหรับการตรวจจับตัวเลข)  
&emsp;&emsp;&emsp;&emsp;[1.10.1 การเตรียมชุดข้อมูลจาก Roboflow และการแบ่งชุดข้อมูล](#1101-การเตรียมชุดข้อมูลจาก-roboflow-และการแบ่งชุดข้อมูล)  
&emsp;&emsp;&emsp;&emsp;[1.10.2 การฝึกแบบจำลอง YOLO บน Google Colab](#1102-การฝึกแบบจำลอง-yolo-บน-google-colab)  
&emsp;&emsp;&emsp;&emsp;[1.10.3 การประเมินประสิทธิภาพตัวตรวจจับวัตถุ](#1103-การประเมินประสิทธิภาพตัวตรวจจับวัตถุ)  
&emsp;&emsp;[1.11 สภาพแวดล้อมและการจัดการโครงงานด้วย `uv`](#111-สภาพแวดล้อมและการจัดการโครงงานด้วย-uv)  
&emsp;&emsp;&emsp;&emsp;[1.11.1 โครงสร้างไฟล์ของระบบ](#1111-โครงสร้างไฟล์ของระบบ)  
&emsp;&emsp;&emsp;&emsp;[1.11.2 การสร้างสภาพแวดล้อมและการติดตั้งไลบรารี](#1112-การสร้างสภาพแวดล้อมและการติดตั้งไลบรารี)  
&emsp;&emsp;[1.12 การวิเคราะห์รหัสต้นฉบับการประมวลผลคอมพิวเตอร์วิทัศน์](#112-การวิเคราะห์รหัสต้นฉบับการประมวลผลคอมพิวเตอร์วิทัศน์)  
&emsp;&emsp;&emsp;&emsp;[1.12.1 การหมุนภาพและการปรับปรุงคุณภาพภาพ (rotate_image, apply_prep)](#1121-การหมุนภาพและการปรับปรุงคุณภาพภาพ-rotate_image-apply_prep)  
&emsp;&emsp;&emsp;&emsp;[1.12.2 การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต (remap_point, remap_bbox)](#1122-การแปลงพิกัดจุดเดี่ยวและกล่องขอบเขต-remap_point-remap_bbox)  
&emsp;&emsp;&emsp;&emsp;[1.12.3 การกรองแถวตัวเลขแนวตั้ง (is_vertical)](#1123-การกรองแถวตัวเลขแนวตั้ง-is_vertical)  
&emsp;&emsp;&emsp;&emsp;[1.12.4 การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม (detect_digits_best)](#1124-การค้นหาทิศทางและฟิลเตอร์ที่เหมาะสม-detect_digits_best)  
&emsp;&emsp;&emsp;&emsp;[1.12.5 การตรวจจับทิศทางข้อความและสัญลักษณ์ m (detect_dial_text_orientation)](#1125-การตรวจจับทิศทางข้อความและสัญลักษณ์-m-detect_dial_text_orientation)  
...
&emsp;&emsp;[3.1 การบูรณาการระบบประมวลผลหลักและกลไกความปลอดภัย](#31-การบูรณาการระบบประมวลผลหลักและกลไกความปลอดภัย)  
&emsp;&emsp;&emsp;&emsp;[3.1.1 การตรวจจับภาพกลับหัวแบบสมมาตรด้วยฟังก์ชัน `flip_guard`](#311-การตรวจจับภาพกลับหัวแบบสมมาตรด้วยฟังก์ชัน-flip_guard)  
&emsp;&emsp;&emsp;&emsp;[3.1.2 ฟังก์ชันประมวลผลหลัก `read_meter`](#312-ฟังก์ชันประมวลผลหลัก-read_meter)  
&emsp;&emsp;&emsp;&emsp;[3.1.3 การบูรณาการตัวตรวจจับข้อความและสัญลักษณ์ m ในระบบความปลอดภัยและจัดระนาบภาพ](#313-การบูรณาการตัวตรวจจับข้อความและสัญลักษณ์-m-ในระบบความปลอดภัยและจัดระนาบภาพ)  
&emsp;&emsp;[3.2 การพัฒนาส่วนเชื่อมต่อโปรแกรมประยุกต์ด้วย FastAPI](#32-การพัฒนาส่วนเชื่อมต่อโปรแกรมประยุกต์ด้วย-fastapi)  
&emsp;&emsp;[3.3 การพัฒนาส่วนติดต่อผู้ใช้ด้วย Gradio](#33-การพัฒนาส่วนติดต่อผู้ใช้ด้วย-gradio)  
&emsp;&emsp;[3.4 การทดสอบระบบและแนวทางการแก้ไขปัญหา](#34-การทดสอบระบบและแนวทางการแก้ไขปัญหา)  
&emsp;&emsp;&emsp;&emsp;[3.4.1 วิธีการสั่งทำงานระบบด้วย `uv`](#341-วิธีการสั่งทำงานระบบด้วย-uv)  
&emsp;&emsp;&emsp;&emsp;[3.4.2 แนวทางการวิเคราะห์และแก้ไขปัญหา](#342-แนวทางการวิเคราะห์และแก้ไขปัญหา)  
&emsp;&emsp;&emsp;&emsp;[3.4.3 ผลการประเมินประสิทธิภาพเชิงประจักษ์และการยืนยันความถูกต้อง](#343-ผลการประเมินประสิทธิภาพเชิงประจักษ์และการยืนยันความถูกต้อง)  
&emsp;&emsp;&emsp;&emsp;[3.4.4 ตารางสรุปข้ออ้างและหลักฐาน](#344-ตารางสรุปข้ออ้างและหลักฐาน)  
&emsp;&emsp;&emsp;&emsp;[3.4.5 การประเมินแบบ End-to-End และโปรโตคอลทำซ้ำได้](#345-การประเมินแบบ-end-to-end-และโปรโตคอลทำซ้ำได้)  
&emsp;&emsp;&emsp;&emsp;[3.4.6 ผลการศึกษาเชิงตัดทอนแบบก้าวหน้า 9 ขั้นตอน](#346-ผลการศึกษาเชิงตัดทอนแบบก้าวหน้า-9-ขั้นตอน)  
&emsp;&emsp;&emsp;&emsp;[3.4.7 ผลการวัดเวลาประมวลผลและการใช้ทรัพยากร](#347-ผลการวัดเวลาประมวลผลและการใช้ทรัพยากร)  
&emsp;&emsp;&emsp;&emsp;[3.4.8 ผลการประเมินประสิทธิภาพตัวตรวจจับวัตถุระดับคลาสและตัวชี้วัดสากล](#348-ผลการประเมินประสิทธิภาพตัวตรวจจับวัตถุระดับคลาสและตัวชี้วัดสากล)  
&emsp;&emsp;&emsp;&emsp;[3.4.9 การวิเคราะห์ข้อผิดพลาดและมาตรการป้องกันเชิงวิศวกรรม](#349-การวิเคราะห์ข้อผิดพลาดและมาตรการป้องกันเชิงวิศวกรรม)  
&emsp;&emsp;&emsp;&emsp;[3.4.10 การวิเคราะห์ความไม่แน่นอนทางสถิติและการตอบคำถามการวิจัย](#3410-การวิเคราะห์ความไม่แน่นอนทางสถิติและการตอบคำถามการวิจัย)  
&emsp;&emsp;[3.5 ข้อควรพิจารณาสำหรับการนำระบบไปใช้งานจริง](#35-ข้อควรพิจารณาสำหรับการนำระบบไปใช้งานจริง)  
[บทที่ 4: สรุปผลการศึกษา อภิปรายผล และข้อเสนอแนะ](#บทที่-4-สรุปผลการศึกษา-อภิปรายผล-และข้อเสนอแนะ)  
&emsp;&emsp;[4.1 สรุปผลการพัฒนาโครงงาน](#41-สรุปผลการพัฒนาโครงงาน)  
&emsp;&emsp;[4.2 อภิปรายผลการดำเนินงาน](#42-อภิปรายผลการดำเนินงาน)  
&emsp;&emsp;[4.3 ข้อจำกัดของระบบ](#43-ข้อจำกัดของระบบ)  
&emsp;&emsp;[4.4 ข้อเสนอแนะสำหรับการพัฒนาต่อยอด](#44-ข้อเสนอแนะสำหรับการพัฒนาต่อยอด)  
...
&emsp;&emsp;&emsp;&emsp;1.3.2.2 คำถามการวิจัยที่ 2 (RQ2 - ประสิทธิผลของการค้นหาเชิงสมมติฐานพหุคูณ): การใช้กลยุทธ์ค้นหาเชิงสมมติฐานพหุคูณ 12 รูปแบบ (4 ทิศทางการหมุน × 3 ฟิลเตอร์ปรับปรุงภาพ) ช่วยเพิ่มอัตราความสำเร็จในการอ่านค่า (Success Rate) และความแม่นยำระดับทั้งตัวเลข (Exact Reading Accuracy) เมื่อเทียบกับการประมวลผลภาพเดี่ยวมุมเดิม (Baseline Single-pass) มากน้อยเพียงใด?<br>
...
&emsp;&emsp;&emsp;&emsp;1.5.3 องค์ความรู้ด้านการประยุกต์ใช้แบบจำลอง YOLO และแบบจำลองวิชัน-แลงเกวจ (Vision-Language Model) ร่วมกันสำหรับงาน OCR ในสภาพแวดล้อมจริง ซึ่งสามารถนำไปปรับใช้กับงานอ่านค่าอุปกรณ์วัดประเภทอื่นได้

---

### 1.6 ทฤษฎีและหลักการพื้นฐาน
...
&emsp;&emsp;&emsp;&emsp;เทคโนโลยีการรู้จำอักขระด้วยแสง (Optical Character Recognition: OCR) ในรุ่นใหม่ เช่น Tesseract 4 เป็นต้นมา ใช้แบบจำลองโครงข่ายประสาทเทียมแบบ LSTM สำหรับการรู้จำข้อความ โดยทำงานร่วมกับกระบวนการวิเคราะห์โครงร่างเอกสารและการแบ่งบริเวณข้อความ อย่างไรก็ตาม ประสิทธิภาพของ OCR ทั่วไปอาจลดลงเมื่อภาพมีการเอียง แสงสะท้อน หรือสัญญาณรบกวนสูง ในทางตรงกันข้าม การประยุกต์ใช้การตรวจจับวัตถุด้วยการเรียนรู้เชิงลึก (Deep Learning-based Object Detection) จะมองตัวเลขอารบิกแต่ละหลักเป็นวัตถุหนึ่งชิ้น ทำให้ระบบสามารถตรวจจับตำแหน่งและรู้จำค่าตัวเลขได้พร้อมกันโดยตรงจากภาพถ่ายเต็มเฟรมโดยไม่ต้องพึ่งพากระบวนการตัดภาพล่วงหน้า

#### 1.6.2 แบบจำลองการตรวจจับวัตถุ YOLO

&emsp;&emsp;&emsp;&emsp;โครงงานนี้เลือกใช้แบบจำลอง YOLO (You Only Look Once) ซึ่งเป็นสถาปัตยกรรมโครงข่ายประสาทเทียมแบบคอนโวลูชันสำหรับการตรวจจับวัตถุแบบขั้นตอนเดียว (Single-stage Object Detector) ซึ่งเป็นหนึ่งในสถาปัตยกรรมแบบ one-stage object detector ที่ได้รับการพัฒนาและใช้งานอย่างต่อเนื่อง โดยแบบจำลองจะรับข้อมูลภาพทั้งหมดเข้าสู่โครงข่ายและทำนายพิกัดกรอบขอบเขตพร้อมประเภทของวัตถุทั้งหมดได้ในรอบการคำนวณเพียงครั้งเดียว (Ultralytics, 2026; Zou et al., 2023)
...
&emsp;&emsp;&emsp;&emsp;2. แบบจำลอง YOLO มีข้อดีอย่างไร: สถาปัตยกรรม YOLO ทำงานแบบขั้นตอนเดียว (Single-stage) ซึ่งทำนายพิกัดกรอบและคลาสตัวเลขพร้อมกันในรอบการคำนวณเดียว ตามเอกสารของ Ultralytics (2026) สถาปัตยกรรม YOLO รุ่นใหม่ใช้การออกแบบแบบไร้กล่องสมอ (Anchor-free) โดยการออกแบบแบบ Anchor-free ช่วยลดการพึ่งพากล่องต้นแบบ โดยประสิทธิภาพในการตรวจจับวัตถุขนาดเล็กขึ้นอยู่กับสถาปัตยกรรม การฝึก และข้อมูลที่ใช้ ทั้งนี้ เวลาประมวลผลขึ้นอยู่กับฮาร์ดแวร์ ความละเอียดภาพ และจำนวนสมมติฐานที่ใช้ โดยโครงงานนี้รายงานเวลาประมวลผลจริงอย่างละเอียดในหัวข้อ 3.4.7 (จำแนกตามขั้นตอน Preprocessing, Inference และ Postprocessing) นอกจากนี้ ในขั้นตอนการฝึกฝน โครงงานได้กำหนดเทคนิค Data Augmentation ใน `training/yolo_train.py` (อาทิ Mosaic, Mixup, การหมุนองศา และการปรับค่า HSV) เพื่อเพิ่มความทนทานของแบบจำลองต่อสภาพแวดล้อมที่หลากหลาย

&emsp;&emsp;&emsp;&emsp;3. นำมาใช้เพื่อวัตถุประสงค์ใด: โครงงานเลือกใช้ YOLO เพื่อลดการพึ่งพาการตัดภาพบริเวณตัวเลขล่วงหน้า และเพื่อให้การตรวจจับตำแหน่งกับการจำแนกตัวเลขสามารถดำเนินการภายในขั้นตอนเดียวกัน โดยความสามารถในการรองรับภาพที่มีความเอียงหรือสภาพแวดล้อมซับซ้อนขึ้นอยู่กับข้อมูลฝึกและขั้นตอนประมวลผลที่ใช้ในโครงงาน

&emsp;&emsp;&emsp;&emsp;ในระดับภาพรวม YOLO26 ประกอบด้วยส่วนสำหรับการสกัดคุณลักษณะ การรวมคุณลักษณะหลายระดับ และ detection head สำหรับทำนายตำแหน่งและประเภทของวัตถุ โดย YOLO26 เพิ่มการออกแบบด้านการอนุมานแบบ end-to-end, DFL-free regression และการปรับปรุงกระบวนการฝึก เช่น Progressive Loss และ STAL ตามเอกสารของ Ultralytics (2026):<br>
1.6.2.1 ส่วนสกัดคุณลักษณะ (Feature Extraction Backbone): ทำหน้าที่สกัดคุณลักษณะของภาพในระดับความละเอียดต่าง ๆ ตั้งแต่เส้นขอบ พื้นผิว จนถึงรูปร่างของตัวเลข<br>
1.6.2.2 ส่วนรวมคุณลักษณะหลายระดับ (Multi-Scale Feature Fusion Neck): ทำหน้าที่ผสานคุณลักษณะจากระดับลึกและระดับตื้นเข้าด้วยกัน เพื่อรักษารายละเอียดของตัวเลขขนาดเล็กและบริบทภาพรวมของหน้าปัด<br>
1.6.2.3 ส่วนหัวตรวจจับ (Detection Head): ทำหน้าที่ทำนายพิกัด Bounding Box ค่าความเชื่อมั่น และคลาสตัวเลข 0–9 โดยตรงจากแผนที่ฟีเจอร์
...
| สถาปัตยกรรมแบบจำลอง | จำนวนพารามิเตอร์ (Params) | VRAM โดยประมาณจากการทดลองของโครงงาน | จุดเด่นเชิงทฤษฎี | ข้อจำกัดสำหรับการประยุกต์ใช้ในงานนี้ | แหล่งอ้างอิงเอกสาร |
|---|---|---|---|---|---|
| YOLO26 Nano | ~2.6M | ~1.5 GB | ประมวลผลเร็วที่สุด น้ำหนักเบา รองรับทั้ง CPU/GPU ทั่วไป | ค่าความแม่นยำ mAP ต่ำกว่ารุ่นขนาดใหญ่ในงานตรวจจับตัวเลขขนาดเล็กบนหน้าปัด | Ultralytics (2026) |
| YOLO26 Small | ~11M | ~3.0 GB | ความสามารถในการตรวจจับรายละเอียดสูงขึ้น | ขนาดโมเดลและสมรรถนะการสกัดฟีเจอร์ระดับกลาง | Ultralytics (2026) |
| **YOLO26 Medium (เลือกใช้ฝึก/ใช้งานจริง)** | **20.4M** | **~5.0 GB** | **ความแม่นยำในการตรวจจับวัตถุขนาดเล็กสูง เหมาะกับตัวเลขบนหน้าปัดมาตรวัด** | ใช้ VRAM และเวลาคำนวณมากกว่ารุ่น Nano แต่แลกมาด้วยค่า mAP@50 ที่สูงกว่าในการทดลองเบื้องต้นของโครงงาน | Ultralytics (2026) |
| Faster R-CNN (ResNet-50) | ~41M | ~6.5 GB+ | สถาปัตยกรรม Two-stage แม่นยำกับวัตถุซ้อนทับ | โครงสร้างซับซ้อน อัตราการประมวลผลช้าเกินไปสำหรับงานหน้างาน | Ren et al. (2015) |
| Tesseract OCR | — | ต่ำ (<500 MB) | ติดตั้งง่ายโดยไม่ต้องสร้างกล่องกำกับพิกัดตัวเลข | ประสิทธิภาพอาจลดลงเมื่อภาพมีการเอียง แสงสะท้อน หรือสัญญาณรบกวนบนพื้นผิว | Smith (2007) |

<p align="center"><em>ที่มา: ปรับปรุงจาก Ultralytics (2026), Ren et al. (2015), และ Smith (2007)</em><br><em>* หมายเหตุ: ค่า VRAM ในตารางเป็นค่าโดยประมาณจากการทดลองของโครงงาน ค่าดังกล่าวขึ้นอยู่กับ batch size, image size และสภาพแวดล้อมของการรัน</em></p>

&emsp;&emsp;&emsp;&emsp;จากตารางที่ 1.1 โครงงานตัดสินใจเลือกฝึกฝนและใช้งานจริงด้วย YOLO26 Medium (`yolo26m.pt`) ซึ่งไฟล์น้ำหนัก `weights/MeterOCR.pt` ที่ได้จากการฝึกมี 132 layers, 20,364,070 parameters (~20.4M หรือ 20.36M) และ 68.1 GFLOPs ตรงกับสถาปัตยกรรม Medium การเลือกรุ่น Medium แทน Nano เป็นผลจากการทดลองเบื้องต้นบน Google Colab (GPU NVIDIA Tesla T4) ซึ่งพบว่า Medium ให้ค่า mAP@50 บน validation set สูงกว่า Nano ในการทดลองเบื้องต้นของโครงงานในงานตรวจจับตัวเลขขนาดเล็กบนหน้าปัดมาตรวัด โดยยังสามารถฝึกด้วยขนาดแบทช์ `batch=16` บน T4 ได้อย่างราบรื่น และทำการอนุมาน (Inference) บน CPU ทั่วไปได้อย่างมีเสถียรภาพ (เฉลี่ย 5.83 วินาทีต่อภาพสำหรับ 12 สมมติฐาน)

> [!NOTE]
> **ข้อจำกัดของข้อมูลในตารางที่ 1.1:** ตัวเลขจำนวนพารามิเตอร์ในตารางข้างต้นอ้างอิงตามเอกสารเผยแพร่ของผู้พัฒนาและวรรณกรรมเดิม (Ultralytics, 2026; Ren et al., 2015; Smith, 2007) ขณะที่ตัวเลขขนาดหน่วยความจำ VRAM เป็นค่าสังเกตจากการทดลองฝึกฝนจริงของโครงงานบน GPU NVIDIA Tesla T4 (VRAM 16 GB) ด้วยขนาดแบทช์ batch=16 และความละเอียดภาพ imgsz=960 ซึ่งการใช้ VRAM จริงจะแปรผันตามขนาดแบทช์ ขนาดภาพ และฮาร์ดแวร์ที่ใช้ โดยค่าดังกล่าวขึ้นอยู่กับ batch size, image size และสภาพแวดล้อมของการรัน ทั้งนี้ตารางข้างต้นไม่ได้รวมเวลาประมวลผล (Latency) เนื่องจากสภาวะแวดล้อมในการทดสอบของแต่ละเอกสารมีความแตกต่างกันอย่างมาก โดยผลการวัดเวลาจริงของระบบปลายทางถึงปลายทางบนโปรเจกต์นี้ มีการรายงานอย่างละเอียดและควบคุมสภาวะแวดล้อมในหัวข้อ 3.4.7 โดยจำแนกเวลา Preprocessing, Inference, และ Postprocessing ภายใต้ฮาร์ดแวร์ที่ระบุชัดเจน

#### 1.6.3 การจำแนกประเภทภาพแบบ Zero-shot และแบบจำลองภาษา-ภาพ
...
&emsp;&emsp;&emsp;&emsp;โครงงานนี้เลือกใช้แบบจำลอง SigLIP2 (Sigmoid Loss for Language Image Pre-training 2) ซึ่งเป็นแบบจำลอง Vision-Language ขนาดใหญ่ที่พัฒนาโดย Google โดยมีสถาปัตยกรรมแบบตัวเข้ารหัสคู่ (Dual-encoder Architecture) ประกอบด้วย:<br>
1.6.3.1 Vision Encoder (Vision Transformer: ViT-B/16): ทำหน้าที่แปลงภาพถ่ายนำเข้าให้อยู่ในรูปเวกเตอร์คุณลักษณะของภาพ (`image_emb`)<br>
...
&emsp;&emsp;&emsp;&emsp;กระบวนการจำแนกภาพแบบ Zero-shot ของ SigLIP2 ประกอบด้วย 4 ขั้นตอนตามลำดับ:<br>
1.6.3.3 การเข้ารหัสภาพ: แปลงภาพถ่ายนำเข้าเป็นเวกเตอร์มิติสูงด้วย Vision Transformer<br>
1.6.3.4 การเข้ารหัสข้อความ: แปลงข้อความเปรียบเทียบ 4 ตัวเลือก ได้แก่ `"water meter"`, `"electricity meter"`, `"gas meter"`, และ `"not a meter"` เป็นเวกเตอร์ข้อความ<br>
1.6.3.5 การวัดระยะความคล้ายคลึง: คำนวณผลคูณจุด (Dot Product) ระหว่างเวกเตอร์ภาพกับเวกเตอร์ข้อความแต่ละชุด ปรับสเกลด้วยพารามิเตอร์อุณหภูมิ ($\tau$) เพื่อสร้างค่า Logits จากนั้นส่งผ่าน $\sigma(z)$ เพื่อแปลงเป็นความน่าจะเป็น<br>
...
&emsp;&emsp;&emsp;&emsp;เพื่อให้เข้าใจข้อได้เปรียบของ Zero-shot ได้ชัดเจนยิ่งขึ้น ผู้จัดทำขอเปรียบเทียบแนวทางการเรียนรู้ 3 ระดับที่แบบจำลองปัญญาประดิษฐ์สำหรับงานจำแนกประเภทภาพสามารถใช้ได้ ดังนี้:

&emsp;&emsp;&emsp;&emsp;**Zero-shot Learning (การเรียนรู้แบบไม่ใช้ตัวอย่าง):** แบบจำลองจำแนกประเภทภาพได้ทันทีจากคำอธิบายข้อความ โดยไม่ต้องพบภาพตัวอย่างของคลาสนั้นในขั้นตอนการอนุมาน (Inference) เลย แบบจำลองต้องมีความรู้เชิงความหมาย (Semantic Knowledge) ที่ถ่ายทอดมาจากการฝึกฝนก่อนหน้าบนชุดข้อมูลขนาดใหญ่ ตัวอย่างเช่น SigLIP2 สามารถตรวจสอบว่าภาพเป็นมาตรวัดน้ำหรือไม่ โดยใช้เพียงข้อความ `"water meter"` เป็นเงื่อนไขเปรียบเทียบ ไม่ต้องรวบรวมภาพมาตรวัดน้ำมาฝึกเพิ่มเติม

&emsp;&emsp;&emsp;&emsp;**Few-shot Learning (การเรียนรู้แบบใช้ตัวอย่างน้อย):** แบบจำลองได้รับตัวอย่างจำนวนจำกัด เช่น 1-shot, 5-shot หรือ 10-shot เพื่อใช้ในการเรียนรู้หรือปรับตัวกับคลาสเป้าหมาย ในขั้นตอนการอนุมานหรือการปรับปรุงน้ำหนักบางส่วน (Lightweight Fine-tuning) เพื่อให้แบบจำลองสามารถรู้จักคลาสใหม่ได้โดยไม่ต้องผ่านการฝึกฝนเต็มรูปแบบ วิธีนี้เหมาะสำหรับกรณีที่คลาสเป้าหมายเป็นสิ่งเฉพาะทางที่แบบจำลองทั่วไปไม่มีความรู้ และมีภาพตัวอย่างที่มีป้ายกำกับ (Labeled Samples) อยู่บ้างแต่ไม่เพียงพอสำหรับการฝึกเต็มรูปแบบ

&emsp;&emsp;&emsp;&emsp;**Full Fine-tuning (การปรับน้ำหนักแบบเต็มรูปแบบ):** ฝึกน้ำหนักส่วนใหญ่หรือทั้งหมดของแบบจำลองด้วยชุดข้อมูลภาพของคลาสเป้าหมายจำนวนมาก (อาทิ หลักร้อยถึงหลักพันภาพต่อคลาส) วิธีนี้ให้ผลแม่นยำสูงสุดเมื่อมีข้อมูลฝึกเพียงพอ แต่มีต้นทุนด้านการรวบรวมและกำกับป้ายข้อมูล (Data Labeling) และเวลาการฝึกสูงกว่ามาก

&emsp;&emsp;&emsp;&emsp;โครงงานนี้เลือกใช้ **Zero-shot** ผ่าน SigLIP2 เพราะงานคัดกรองภาพมาตรวัดน้ำเป็นงานที่แบบจำลอง Vision-Language ที่ผ่านการฝึกฝนบนชุดข้อมูลขนาดใหญ่อยู่แล้วสามารถทำได้ทันทีผ่านคำอธิบายข้อความ ไม่จำเป็นต้องรวบรวมภาพป้ายกำกับเพิ่มเติม ทำให้ลดต้นทุนการพัฒนาและทำให้ระบบสามารถปรับเปลี่ยนเงื่อนไขการกรองได้เพียงแค่เปลี่ยนข้อความเปรียบเทียบ (`TEXT_LABELS`) โดยไม่ต้องฝึกแบบจำลองใหม่

#### 1.6.4 ทฤษฎีการประมวลผลภาพดิจิทัลและปริภูมิสี
...
1.6.4.1 RGB (Red, Green, Blue): ระบบสีหลักที่กล้องดิจิทัลบันทึก โดยค่าความสว่างและสีจะผสมผสานกันอยู่ในทั้งสามช่องสัญญาณ<br>
1.6.4.2 LAB Color Space: ปริภูมิสีที่แยกช่องความสว่าง (Lightness) ออกจากช่องสีเขียวแดง (แกนเขียว-แดง) และช่องสีเหลืองน้ำเงิน (แกนน้ำเงิน-เหลือง) อย่างเป็นอิสระต่อกัน เหมาะสำหรับการปรับแต่งคอนทราสต์แสงโดยไม่ทำให้โทนสีของภาพผิดเพี้ยน<br>
1.6.4.3 YCrCb Color Space: ปริภูมิสีที่แยกช่องความสว่างวาย (Luminance) ออกจากช่องสัญญาณผลต่างสีแดงต่างและสีน้ำเงินต่าง นิยมใช้ในการกระจายความสว่างทั่วทั้งภาพ<br>
...
1.6.4.5 CLAHE (Contrast Limited Adaptive Histogram Equalization): CLAHE เพิ่มคอนทราสต์ในบริเวณย่อยของภาพ โดยแบ่งภาพออกเป็นกริดย่อยขนาดแปดคูณแปดบล็อก แล้วกระจายความสว่างเฉพาะภายในแต่ละบล็อก พร้อมทั้งจำกัดการขยายคอนทราสต์ของฮิสโตแกรม (Clip Limit = 2.0) เพื่อลดการขยายสัญญาณรบกวนเมื่อเทียบกับ Adaptive Histogram Equalization แบบทั่วไป (Zuiderveld, 1994) เทคนิคนี้ดำเนินการบนช่องความสว่างในระบบสี LAB<br>
...
### 1.7 เทคนิคและอัลกอริทึมที่พัฒนาขึ้นในโครงงาน
...
#### 1.7.2 เทคนิคการค้นหาเชิงสมมติฐานพหุคูณ 12 รูปแบบ
...
#### 1.7.3 เทคนิคการตัดกรอบสี่เหลี่ยมซ้ำซ้อนด้วย IoU
...
#### 1.7.4 เทคนิคการแปลงพิกัดเรขาคณิตย้อนกลับ
...
&emsp;&emsp;&emsp;&emsp;วิธีการทำงาน: ฟังก์ชัน `remap_point` และ `remap_bbox` ใช้หลักการแปลงพิกัดทางเรขาคณิตในการแปลงพิกัดมุมกล่องกลับสู่ระนาบภาพเดิมโดยอ้างอิงความกว้างและความสูงของภาพต้นฉบับ ดังภาพที่ 1.1:<br>
1.7.4.1 หมุนขวา 90°: สลับแกนพิกัดแล้วหักออกจากความสูงของภาพต้นฉบับ<br>
1.7.4.2 กลับหัว 180°: หักพิกัดออกจากความกว้างและความสูงของภาพต้นฉบับ<br>
...
#### 1.7.5 เทคนิคการกรองเค้าโครงแถวตัวเลขแนวตั้ง
...
#### 1.7.6 เทคนิคกลไกความปลอดภัยและการตรวจทานความถูกต้อง
...
&emsp;&emsp;&emsp;&emsp;วิธีการทำงาน: ระบบประกอบด้วยกลไกความปลอดภัย 4 ขั้นตอน:<br>
1.7.6.1 การตรวจสอบภาพกลับหัว 180° (`flip_guard`): ระบบประมวลผลภาพที่มุมตรงข้าม 180° แล้วนำผลการอ่านมาเปรียบเทียบกับตารางความสัมพันธ์ของตัวเลขสมมาตร `FLIP_MAP = {0:0, 1:1, 2:5, 5:2, 6:9, 8:8, 9:6}` หากผลการอ่านไม่สอดคล้องกันและมุมตรงข้ามมีความเชื่อมั่นสูง ระบบจะสร้างข้อความเตือนความเสี่ยงภาพกลับหัวทันที<br>
1.7.6.2 การตรวจทานซ้ำด้วย SigLIP2 (`cross_check_digits`): ระบบจะครอปภาพตัวเลขเฉพาะหลักที่มีค่าความเชื่อมั่นจาก YOLO ต่ำกว่าเกณฑ์ `CONF_RELIABLE = 0.60` แล้วส่งให้แบบจำลอง SigLIP2 จำแนกตัวเลขซ้ำเพื่อตรวจสอบยืนยัน<br>
1.7.6.3 การตรวจสอบความตรงของแนวแถวตัวเลข (`align_ok`): คำนวณค่าเบี่ยงเบนมาตรฐาน (Standard Deviation) ของพิกัดกึ่งกลางแถวตัวเลข หากค่าเบี่ยงเบนเกินกว่า `ALIGN_MAX_SPREAD = 0.10` ระบบจะแจ้งเตือนว่าตัวเลขไม่เรียงตัวในแนวเดียวกัน<br>
1.7.6.4 การตรวจสอบตำแหน่งหลักทศนิยมสีแดง (`red_ratio`): คำนวณสัดส่วนพิกเซลสีแดงในปริภูมิสี HSV เพื่อใช้ตรวจสอบว่าตำแหน่งที่มีสัดส่วนพิกเซลสีแดงสอดคล้องกับตำแหน่งหลักทศนิยมทางขวาของหน้าปัดตามเงื่อนไขที่กำหนด

#### 1.7.7 เทคนิคการตรวจจับทิศทางข้อความและสัญลักษณ์หน่วย m บนหน้าปัดเพื่อจัดวางแนวระนาบ
...
### 1.8 เทคโนโลยี ชุดเครื่องมือ และไลบรารีที่ใช้ในโครงงาน
...
### 1.9 ขั้นตอนและวิธีการทำงานของระบบ
...
#### 1.10.1 การเตรียมชุดข้อมูลจาก Roboflow และการแบ่งชุดข้อมูล
...
&emsp;&emsp;&emsp;&emsp;การปฏิบัติการบน Google Colab: การฝึกแบบจำลองการเรียนรู้เชิงลึก (Deep Learning) ต้องการการประมวลผลเมทริกซ์ประสิทธิภาพสูง จึงกำหนดให้ปฏิบัติตามหัวข้อ 1.10.1–1.10.2 บน Google Colab โดยเปิด [colab.research.google.com](https://colab.research.google.com) สร้างสมุดบันทึกใหม่ชื่อ `train_model_colab.ipynb` และเลือกฮาร์ดแวร์เร่งความเร็วเป็น T4 GPU ดังแสดงในซอร์สโค้ดที่ 1.1:
...
#### 1.10.3 การประเมินประสิทธิภาพตัวตรวจจับวัตถุ
...
&emsp;&emsp;&emsp;&emsp;1.12.1.1 ปัญหา: ภาพถ่ายมีความเอียง ตัวเลขมีความคมชัดต่ำ หรืออยู่ในบริเวณที่มีแสงสว่างไม่เพียงพอ ส่งผลให้ประสิทธิภาพในการตรวจจับตัวเลขของแบบจำลองลดลง<br>
&emsp;&emsp;&emsp;&emsp;1.12.1.2 แนวคิด: ดำเนินการทดสอบหมุนภาพ 4 ทิศทาง (0°, 90°, 180°, 270°) ร่วมกับการปรับปรุงคุณภาพแสง 3 รูปแบบ (ภาพต้นฉบับ, CLAHE, HistEq) รวมเป็น 12 รูปแบบการทดสอบ แล้วจึงให้แบบจำลองปัญญาประดิษฐ์ประเมินและคัดเลือกผลลัพธ์ที่มีความชัดเจนและน่าเชื่อถือสูงสุด<br>
&emsp;&emsp;&emsp;&emsp;1.12.1.3 การทำงาน: ฟังก์ชัน `rotate_image` ดำเนินการหมุนภาพด้วย OpenCV และฟังก์ชัน `apply_prep` ดำเนินการปรับคอนทราสต์ของภาพตามฟิลเตอร์ที่กำหนด
...
1.12.2.1 ระบบหมุนภาพ 90° เพื่อให้แบบจำลองตรวจจับตัวเลขได้สะดวก<br>
1.12.2.2 พิกัดกล่อง `bbox` ที่ตรวจพบจะอยู่ใน ระบบพิกัดของภาพที่ผ่านการหมุน<br>
...
1.12.2.4 หมุน 90° (ตามเข็ม): แกนสลับกัน จุดตำแหน่งบนภาพหมุน จะตรงกับจุดที่สลับแกนและหักออกจากความสูง บนภาพเดิม<br>
1.12.2.5 หมุน 180° (กลับหัว): จุดตำแหน่งบนภาพหมุน จะตรงกับจุดที่หักออกจากความกว้างและความสูง บนภาพเดิม<br>
...
1.12.3.1 ปัญหา: บริเวณตัวเรือนมาตรวัดน้ำมักมีตัวเลขระบุวันที่ผลิตหรือหมายเลขซีเรียลที่พิมพ์ในแนวตั้ง ซึ่งไม่ใช่ค่าตัวเลขบนหน้าปัดที่ต้องการบันทึก<br>
1.12.3.2 แนวคิด: แถวตัวเลขบนหน้าปัดมาตรวัดน้ำมีการเรียงตัวในแนวนอน โดยช่วงความกว้างของแถวต้องมากกว่าช่วงความสูง หากตรวจพบกลุ่มตัวเลขที่มีช่วงความสูงมากกว่าความกว้าง ระบบจะตัดทิ้งจากการคำนวณ<br>
...
1.12.4.1 หมุน 4 ทิศ (0°/90°/180°/270°): ช่วยแก้ปัญหาภาพถ่ายเอียงหรือกลับทิศทาง<br>
1.12.4.2 ปรับแสง 3 แบบ (Orig/CLAHE/HistEq): ช่วยแก้ปัญหาตัวเลขเลือนรางหรืออยู่ในเงามืด<br>
1.12.4.3 YOLO ตรวจจับ: ทำหน้าที่ตรวจจับตำแหน่งตัวเลข 0–9 ทุกหลัก<br>
1.12.4.4 IoU dedup (threshold 0.45): ช่วยตัดกล่องที่ซ้อนทับซ้ำซ้อนให้เหลือกล่องเดียว<br>
1.12.4.5 is_vertical: ทำหน้าที่กรองข้อความวันที่หรือหมายเลขซีเรียลที่เรียงเป็นแนวตั้งทิ้ง<br>
1.12.4.6 red_ratio + Scoring: ใช้ตรวจสอบทิศทางหน้าปัด (หลักทศนิยมสีแดงต้องอยู่ขวาสุด)<br>
1.12.4.7 Scoring (mean_conf × n): ทำหน้าที่คัดเลือกรูปแบบที่มีค่าความเชื่อมั่นและจำนวนหลักสอดคล้องกับเกณฑ์<br>
1.12.4.8 Margin 0.12: ช่วยป้องกันการสลับมุมเมื่อคะแนนมีความใกล้เคียงกัน<br>
...
1.12.4.10 `red_ratio(img_bgr, bbox)` — ตรวจสีแดงของหลักทศนิยม:<br>
 1.12.4.11 ปัญหาที่แก้ไข: การตรวจสอบทิศทางของหน้าปัด — มาตรวัดน้ำที่ใช้ในการศึกษานี้มีหลักทศนิยมแสดงด้วยสีแดงอยู่ตำแหน่งขวาสุด หากตรวจพบสีแดงที่ตำแหน่งซ้ายสุด มีความเป็นไปได้สูงที่ภาพจะกลับหัว<br>
 1.12.4.12 การทำงาน: ครอปภาพเฉพาะภายในกรอบ Bounding Box แปลงเป็นปริภูมิสี HSV แล้วคำนวณสัดส่วนพิกเซลสีแดง

1.12.4.13 `eval_orientation(bgr_img, angle, prep)` — ประเมินคะแนนในแต่ละรูปแบบ:<br>
 1.12.4.14 วัตถุประสงค์: ตัดสินว่าทิศทางและฟิลเตอร์ใดมีความน่าเชื่อถือสูงสุด และกรองผลการตรวจจับที่คลาดเคลื่อน — โดยต้องเรียงตัวในแนวนอนและมีจำนวนหลัก 4–9 หลักจึงจะได้รับการคำนวณคะแนน<br>
...
1.12.4.16 `detect_digits_best(rgb_img)` — คัดเลือกผลลัพธ์ที่ดีที่สุด:<br>
 1.12.4.17 วัตถุประสงค์: คัดเลือกรูปแบบที่เหมาะสมที่สุดจาก 12 รูปแบบการทดสอบ โดยมีเกณฑ์ Margin ป้องกันความผันผวนของมุมองศา<br>
...
<p align="center"><em>ที่มา: สังเคราะห์และเปรียบเทียบจากงานวิจัยของ Liang et al. (2022), Wang & Xiang (2024), Salomon et al. (2022) และ Nguyen et al. (2025)</em></p>
...
```mermaid
flowchart LR
  SG1["<b>ผลลัพธ์ดิบจาก YOLO26</b><br/>(กล่องพิกัด + ตัวเลข + Conf)"] --> SG2["<b>กลไกความปลอดภัย 4 ระดับ</b><br/>(Flip / Cross-check / Align / Red)"]
...
flowchart LR
  ...
  FGC -->|"ค่าขัดแย้ง & มุมตรงข้ามมั่นใจกว่า"| FGW["แจ้งเตือน: ภาพมีความเสี่ยงกลับหัว 180°"]
```
...
2. เปรียบเทียบความสัมพันธ์ของตัวเลขผ่านตารางคู่สมมาตร FLIP_MAP
   2.1 กรณีค่าตัวเลขสอดคล้องกันตามปกติ: ยืนยันว่าทิศทางภาพถูกต้อง<br>
   2.2 กรณีค่าตัวเลขขัดแย้งและมุมตรงข้ามมีค่าความเชื่อมั่นสูงกว่า: สร้างข้อความแจ้งเตือนความเสี่ยงภาพกลับหัว 180 องศา
</details>
...
flowchart LR
  ...
  CCC -->|"ไม่จริง (≥ 0.60)"| CCR["ผ่านเกณฑ์ความเชื่อมั่นที่กำหนด<br/>(CONF_RELIABLE = 0.60)"]
  CCC -->|"จริง (< 0.60)"| CCS["ต่ำกว่าเกณฑ์ → ส่งตรวจทานด้วย SigLIP2<br/>(ครอปเฉพาะภาพตัวเลขจำแนกซ้ำ)"]
...
2. พิจารณาตามเกณฑ์ความเชื่อมั่นที่กำหนด (CONF_RELIABLE เท่ากับ 0.60)
   2.1 ผ่านเกณฑ์ความเชื่อมั่นที่กำหนด (CONF_RELIABLE = 0.60): ยอมรับผลลัพธ์ของแบบจำลอง YOLO26 โดยตรง<br>
   2.2 ต่ำกว่าเกณฑ์ → ส่งตรวจทานด้วย SigLIP2: ครอปภาพเฉพาะตัวเลขหลักดังกล่าวส่งให้แบบจำลอง SigLIP2 จำแนกซ้ำ
...
flowchart LR
  ...
  AL3 -->|"ไม่ตรง"| ALW["แจ้งเตือน: แถวตัวเลขเอียงผิดปกติ"]
  RD1 --> RDC{"หลักแดงอยู่ขวา?"}
  RDC -->|"ใช่"| RDP["ยืนยันตำแหน่งทศนิยมถูกต้อง (+5%)"]
  RDC -->|"ไม่ใช่"| RDW["ตรวจพบหลักแดงอยู่ซ้าย (-50%)"]
```
...
2. ตรวจสอบว่าค่าเบี่ยงเบนมาตรฐานอยู่ในเกณฑ์ที่กำหนดหรือไม่ (ไม่เกิน 0.10)
   2.1 กรณีเกินเกณฑ์: แจ้งเตือนว่าแนวแถวตัวเลขเอียงผิดปกติ<br>
   2.2 กรณีอยู่ในเกณฑ์: วิเคราะห์สัดส่วนสีแดงในปริภูมิสี HSV ที่กล่องขวาสุด
3. ตรวจสอบตำแหน่งของหลักทศนิยมสีแดง
   3.1 กรณีหลักสีแดงอยู่ขวาสุด: ยืนยันโครงสร้างหน้าปัดถูกต้อง พร้อมมอบโบนัสร้อยละ 5<br>
   3.2 กรณีหลักสีแดงอยู่ซ้ายสุด: แจ้งเตือนความผิดปกติและปรับลดคะแนนลงร้อยละ 50
</details>
...
3.1.1.1 ปัญหา: ตัวเลขอารบิกบางตัวมีลักษณะสมมาตรเชิงเรขาคณิตเมื่อหมุน 180° เช่น 6 กับ 9, 2 กับ 5 รวมถึง 0, 1 และ 8 ส่งผลให้ภาพที่กลับหัวยังคงสามารถตรวจจับตัวเลขได้แต่ให้ค่าผลลัพธ์ที่ไม่ถูกต้อง<br>
3.1.1.2 แนวคิดการแก้ไข: ประมวลผลภาพที่มุมตรงข้าม 180° เพื่อตรวจสอบความสอดคล้อง หากผลลัพธ์ไม่สอดคล้องกับตารางการจับคู่สมมาตร `FLIP_MAP` แสดงว่าภาพต้นฉบับอาจอยู่ในทิศทางกลับหัว ระบบจึงสร้างการแจ้งเตือนแก่ผู้ใช้งาน<br>
...
&emsp;&emsp;&emsp;&emsp;รายละเอียดทางเทคนิคของกระบวนการ: ฟังก์ชัน `read_meter` ทำหน้าที่เป็นศูนย์กลางควบคุมกระบวนการประมวลผลหลัก (Main Pipeline Controller) โดยเชื่อมโยง 4 ขั้นตอนต่อเนื่อง ได้แก่ การคัดกรองประเภทมาตรวัดน้ำ การค้นหาทิศทางและตรวจจับตัวเลข การกรองคอลัมน์แนวตั้ง และการตรวจสอบความปลอดภัยทางเรขาคณิต ในกระบวนการนี้ระบบจะคำนวณความตรงแนวของตัวเลข (`align_ok`) ด้วยค่าเบี่ยงเบนมาตรฐาน ตรวจสอบความสอดคล้องของตัวเลขรายหลักร่วมกับ SigLIP2 (`cross_check_digits`) และรวบรวมรายการแจ้งเตือน (`warnings`) ทุกกรณีที่มีความเสี่ยง เพื่อให้ผู้ใช้งานสามารถตรวจสอบความถูกต้องได้อย่างโปร่งใส ดังแสดงในซอร์สโค้ดที่ 3.2:
...
&emsp;&emsp;&emsp;&emsp;ผลลัพธ์ที่คาดหวัง: ฟังก์ชันส่งคืนพจนานุกรมข้อมูลประกอบด้วย สตริงตัวเลขที่อ่านได้ (`reading`), รายการข้อมูลตัวเลขรายหลักพร้อมพิกัด Bounding Box และค่าความเชื่อมั่น (`digits`), ค่าความเชื่อมั่นเฉลี่ย (`mean_confidence`), รายการแจ้งเตือนความเสี่ยง (`warnings`), ออบเจกต์ตรวจสอบความปลอดภัย (`safety_guards`) ซึ่งมีสถานะการตรวจจับข้อความและสัญลักษณ์หน่วย m บนหน้าปัด (`dial_text_vertical`, `rotated_for_dial_text`), และเวลาประมวลผล (`elapsed_ms`)

---

#### 3.1.3 การบูรณาการตัวตรวจจับข้อความและสัญลักษณ์ m ในระบบความปลอดภัยและจัดระนาบภาพ
3.1.3.1 ปัญหา: เมื่อถ่ายภาพมาตรวัดน้ำในมุมตะแคง 90° หรือ 270° หรือติดตั้งในแนวดิ่งตามแนวท่อ ตัวเลขบางตัวที่มีความสมมาตรทางเรขาคณิต (เช่น 0, 1, 8 หรือ 2 กับ 5) อาจส่งผลให้แบบจำลองอ่านค่ากลับหัวหรือเลือกมุมที่แถวตัวเลขยังคงตั้งอยู่ (เช่น สับสนระหว่าง 01535 กับ 53510) การใช้เฉพาะการตรวจจับแถวตัวเลขอย่างเดียวจึงอาจเกิดความผิดพลาดได้<br>
3.1.3.2 แนวคิด: ผสานผลการตรวจจับจากฟังก์ชัน `detect_dial_text_orientation` เข้าสู่ระบบความปลอดภัย (Safety Guards Framework) โดยส่งสัญญาณควบคุมระนาบภาพไปยัง `detect_digits_best` เพื่อบังคับข้ามเกณฑ์ Margin Rule และหมุนปรับภาพเข้าสู่มุม 90° หรือ 270° ที่ข้อความวางตัวในแนวนอนโดยอัตโนมัติ<br>
3.1.3.3 การทำงาน: ภายในฟังก์ชัน `read_meter` ระบบจะตรวจสอบสถานะ `rotated_for_dial_text` หากมีการหมุนปรับภาพตามข้อความหรือสัญลักษณ์หน่วย $m$ ระบบจะสร้างข้อความแจ้งเตือนระบุว่า *"ตรวจพบสัญลักษณ์ m หรือตัวอักษรบนหน้าปัดในแนวตั้ง — ปรับหมุนภาพ {angle}° ให้อ่านในแนวนอนเพื่อลดความคลาดเคลื่อน"* พร้อมแนบข้อมูลสถานะใน `safety_guards` เพื่อให้ส่วนประสานงานผู้ใช้ (Web UI) แสดงผลการ์ดความปลอดภัยและป้ายกำกับสีครามได้อย่างชัดเจน
...
&emsp;&emsp;&emsp;&emsp;เพื่อให้ระบบอ่านค่ามาตรวัดน้ำสามารถบูรณาการเข้ากับระบบภายนอก เช่น แอปพลิเคชันบนอุปกรณ์เคลื่อนที่ของเจ้าหน้าที่ภาคสนาม หรือระบบฐานข้อมูลส่วนกลาง โครงงานนี้ได้พัฒนาส่วนเชื่อมต่อโปรแกรมประยุกต์ตามสถาปัตยกรรม REST API ด้วยเฟรมเวิร์ก FastAPI (Ramírez, 2024) ซึ่งรองรับการประมวลผลแบบอะซิงโครนัสและสร้างเอกสารทดสอบระบบแบบโต้ตอบ (Interactive Swagger UI) โดยอัตโนมัติที่เส้นทาง `/docs`

&emsp;&emsp;&emsp;&emsp;สถาปัตยกรรมการให้บริการและการประมวลผล: เซิร์ฟเวอร์เปิดให้บริการที่พอร์ต `8000` (`http://127.0.0.1:8000`) โดยกำหนดเส้นทางการทำงานหลัก 2 ส่วน ได้แก่
1. `GET /api/health` สำหรับตรวจสอบความพร้อมในการทำงานของระบบ และสถานะการโหลดแบบจำลอง YOLO และ SigLIP2 ในหน่วยความจำ
2. `POST /api/read-meter` สำหรับรับไฟล์ภาพถ่ายมาตรวัดน้ำผ่านโพรโทคอล HTTP Multipart Form Data

&emsp;&emsp;&emsp;&emsp;ในด้านการจัดการทรัพยากรการคำนวณ เนื่องจากอัลกอริทึมการค้นหา 12 สมมติฐานและแบบจำลองการเรียนรู้เชิงลึกเป็นงานที่ใช้ภาระซีพียูสูง (CPU-bound workload) ระบบจึงส่งต่องานฟังก์ชัน `read_meter()` เข้าสู่เธรดพูลเบื้องหลังด้วย `run_in_threadpool` เพื่อป้องกันไม่ให้ภาระงานประมวลผลเชิงคำนวณปิดกั้น Event Loop ของเซิร์ฟเวอร์ ทำให้ระบบสามารถรองรับการเชื่อมต่อเครือข่ายอื่นได้อย่างต่อเนื่อง พร้อมทั้งมีระบบคัดกรองชนิดไฟล์นำเข้าผ่านเซต `ALLOWED_TYPES` และส่งคืนผลลัพธ์ในโครงสร้าง JSON มาตรฐาน ดังแสดงในซอร์สโค้ดที่ 3.3:
...
&emsp;&emsp;&emsp;&emsp;เพื่อให้การทดสอบการทำงานของระบบมีความสะดวกและสามารถสาธิตผลลัพธ์แก่ผู้ใช้งานทั่วไปได้โดยตรง โครงงานนี้ได้พัฒนาส่วนติดต่อผู้ใช้บนเว็บ (Web UI) ด้วยไลบรารี Gradio (Abid et al., 2019) ซึ่งเปิดให้บริการที่พอร์ต `7860` (`http://127.0.0.1:7860`)

&emsp;&emsp;&emsp;&emsp;การทำงานของส่วนประสานงานผู้ใช้: โครงสร้างหน้าต่างแสดงผลประกอบด้วย 2 ส่วนหลัก ได้แก่ ฝั่งรับข้อมูลเข้าซึ่งมีช่องอัปโหลดไฟล์ภาพและปุ่มสั่งประมวลผล และฝั่งแสดงผลลัพธ์ซึ่งรายงานค่าตัวเลขที่อ่านได้ ค่าความเชื่อมั่นเฉลี่ยของแบบจำลอง และกล่องข้อความแจ้งเตือนการตรวจสอบความถูกต้อง เมื่อผู้ใช้กดปุ่มสั่งการ รหัสต้นฉบับจะแปลงภาพเป็นไบต์สตรีม JPEG ผ่าน `io.BytesIO` และส่งคำขอผ่านเครือข่ายไปยัง FastAPI Backend (`POST /api/read-meter`) ด้วยไคลเอนต์ `httpx` จากนั้นนำผลลัพธ์ JSON มาแจกแจงเพื่อเรนเดอร์ข้อมูลบนหน้าเว็บแบบเรียลไทม์ ดังแสดงในซอร์สโค้ดที่ 3.4:
...
def predict(image: Image.Image | None):
    ...
    warn_text = "\n".join(f"-  {w}" for w in warnings) if warnings else " ไม่พบข้อผิดพลาด"
...
3.4.1.1 เปิด Terminal 1 — รัน FastAPI Backend: เริ่มต้นการทำงานของเซิร์ฟเวอร์ส่วนเชื่อมต่อโปรแกรมประยุกต์ ดังแสดงในชุดคำสั่งที่ 3.1:
...
3.4.1.2 เปิด Terminal 2 — รัน Gradio Web UI: เริ่มต้นการทำงานของส่วนประสานงานผู้ใช้บนเว็บเบราว์เซอร์ ดังแสดงในชุดคำสั่งที่ 3.2:
...
&emsp;&emsp;&emsp;&emsp;ผลลัพธ์ที่คาดหวัง: หน้าต่างคำสั่งแสดงข้อความการทำงาน `Running on local URL: http://127.0.0.1:7860` และสามารถเข้าใช้งานส่วนติดต่อผู้ใช้ผ่านเว็บเบราว์เซอร์ได้ ดังแสดงในภาพที่ 3.2:
...
#### 3.4.2 แนวทางการวิเคราะห์และแก้ไขปัญหา

&emsp;&emsp;&emsp;&emsp;ตารางที่ 3.1 แจกแจงแนวทางการวิเคราะห์อาการผิดปกติ สาเหตุที่เป็นไปได้ จุดตรวจสอบ และวิธีแก้ไขปัญหา พร้อมผลลัพธ์ที่คาดว่าจะได้รับ เพื่อสนับสนุนการแก้ไขปัญหาเชิงปฏิบัติการ ดังนี้
...
| **อ่านได้เลขกลับหัว เช่น 9 เป็น 6** | ภาพถ่ายหมุนกลับหัว 180° และไม่มีหลักทศนิยมสีแดงให้สังเกต | ตรวจสอบรายการแจ้งเตือนในฟิลด์ `warnings` | ระบบจะแจ้งเตือน `[คำเตือน] อาจกลับหัว` เพื่อให้เจ้าหน้าที่ตรวจสอบยืนยันก่อนบันทึกข้อมูล | มีข้อความแจ้งเตือนความเสี่ยงอย่างชัดเจน |
...
#### 3.4.3 ผลการประเมินประสิทธิภาพเชิงประจักษ์และการยืนยันความถูกต้อง

&emsp;&emsp;&emsp;&emsp;เพื่อให้การประเมินประสิทธิภาพของระบบเป็นไปตามหลักการวิจัยทางคอมพิวเตอร์วิทัศน์ที่สามารถตรวจสอบซ้ำได้ โครงงานนี้ได้ดำเนินการทดสอบและประเมินผลระบบผ่านชุดข้อมูล 2 ระดับอย่างเป็นรูปธรรม ได้แก่
1. ชุดข้อมูลทดสอบที่กันออกจากการฝึก (Held-out Test Split, n=120 ภาพ ประกอบด้วยตัวเลขเฉลย Ground Truth 941 หลัก จากชุดข้อมูล Roboflow ทั้งหมด 194 ภาพ): ประเมินความสามารถในการขยายผลทั่วไป (Generalizability) ของท่อประมวลผลทั้งระบบ เพื่อวัด Exact Reading Accuracy, Digit-level Accuracy, Digit Error Rate (DER), Mean Model Confidence และเวลาประมวลผลเฉลี่ยต่อภาพ
2. ชุดข้อมูลภาพสาธิตภาคสนาม (Field Demonstration Set, n=7 ภาพ): ทดสอบความคงทนต่อการติดตั้งเอียง คราบสิ่งสกปรก แสงสะท้อน และประเมินคุณูปการส่วนเพิ่มของแต่ละโมดูลผ่านการศึกษาเชิงตัดทอนแบบก้าวหน้า 9 ขั้นตอน (9-Stage Progressive Ablation Study)

<p align="center"><strong>ตารางที่ 3.2: ผลการประเมินประสิทธิภาพระบบอ่านค่ามาตรวัดน้ำบนชุดทดสอบที่กันออกจากการฝึกและชุดสาธิตภาคสนาม</strong></p>

| ตัวชี้วัดประสิทธิภาพ (Metric) | ชุดทดสอบที่กันออกจากการฝึก (Test Split, n=120) | ชุดสาธิตภาคสนาม (Demo Set, n=7) | นิยามทางคณิตศาสตร์และขอบเขตการวัด |
|---|:---:|:---:|---|
...
| **Exact Reading Accuracy** | **67.5% (81/120)**<br>[Wilson 95% CI: 58.7%, 75.2%] | **100.0% (7/7)**<br>[Wilson 95% CI: 64.6%, 100.0%] | สัดส่วนภาพที่อ่านตัวเลขถูกต้องตรงเฉลยครบทุกหลัก 100% |
| **Digit-level Accuracy** | **90.44% (851/941)**<br>[Wilson 95% CI: 88.4%, 92.2%] | **100.0% (36/36)**<br>[Wilson 95% CI: 90.4%, 100.0%] | สัดส่วนตำแหน่งตัวเลขที่ทำนายถูกต้องต่อจำนวนหลักทั้งหมด |
| **Digit Error Rate (DER)** | **7.33% (0.0733)** | **0.00% (0.0000)** | อัตราความผิดพลาด คำนวณจาก $(S+D+I)/N_{\text{ref}}$ |
| **Mean Model Confidence** | **0.8566** (0.798–0.895) | **0.8610** (0.816–0.891) | ค่าความเชื่อมั่นเฉลี่ยของกล่องตัวเลขจาก YOLO |
| **Reading Success Rate** | **100.0% (120/120)** | **100.0% (7/7)** | สัดส่วนภาพที่ระบบตรวจจับและส่งออกผลลัพธ์สำเร็จ |
| **เวลาประมวลผลเฉลี่ย (CPU Latency)** | **533.2 ms ต่อภาพ** | **5,828.8 ms ต่อภาพ** (12 สมมติฐาน) | วัดบน CPU AMD Ryzen 5 8645HS (YOLO_IMGSZ=960) |

<p align="center"><em>ที่มา: ผลการประเมินเชิงประจักษ์บนชุดข้อมูลทดสอบที่กันออกจากการฝึกและชุดสาธิตภาคสนามในโครงงานนี้</em></p>
...
| โหมด (Mode) | `success_rate` | `avg_mean_conf` | `avg_latency` | หมายเหตุเชิงประจักษ์บนชุดสาธิต |
|---|---|---|---|---|
...
| `rotate-4` (4มุม+orig) | **100.0% (7/7)** | 0.846 | 2.95s | การหมุน 4 ทิศทางช่วยกู้คืนภาพเอียง ส่งผลให้อัตราความสำเร็จเพิ่มขึ้นจาก 57.1% เป็น 100.0% ในชุดสาธิตนี้ |
| `full-12` (4มุม×3ฟิลเตอร์, ปัจจุบัน) | **100.0% (7/7)** | **0.861** | 6.39s | เพิ่ม CLAHE และ HistEq ได้ `mean_conf` สูงสุด แม้เวลาประมวลผลเพิ่มขึ้นเป็น 6.39s |
...
> **สรุปผลการทดสอบเชิงสังเกต:** การเปิดใช้งานกลไกหมุนค้นหา 4 ทิศทาง (`rotate-4`) ช่วยเพิ่มอัตราความสำเร็จในการอ่านจาก 57.1% (4/7) เป็น 100.0% (7/7) ในชุดสาธิตนี้ ซึ่งสะท้อนแนวโน้มว่าการหมุนภาพช่วยกู้คืนภาพมิเตอร์ที่ติดตั้งเอียงได้จริง อย่างไรก็ตาม เนื่องจากขนาดตัวอย่างมีเพียง n=7 ผลลัพธ์นี้จึงยังไม่สามารถสรุปนัยสำคัญทางสถิติ (Statistical Significance) ในระดับประชากรภาพทั่วไปได้ จนกว่าจะได้รับการทดสอบซ้ำบนชุดทดสอบที่มีขนาดและความหลากหลายเพียงพอ
...
|---|---|---|---|
| **1. ชุดตัวเลขสมบูรณ์ (End-to-End)** | **Exact Reading Accuracy** | $N_{\text{exact}} / N_{\text{total}}$ | สัดส่วนภาพที่ระบบอ่านค่าตัวเลขได้ถูกต้องตรงกับ Ground Truth ครบทุกหลัก 100% (ถูกหมด=1, ผิดแม้หลักเดียว=0) |
...
| อ่านค่ามิเตอร์ถูกครบทุกหลัก | วัด Exact Reading Accuracy / Digit-level Accuracy บน test set ที่มี ground-truth reading | **พิสูจน์แล้วบนชุดข้อมูลทดสอบที่กันออกจากการฝึก (Supported on Test Split)** — วัดผลจริงบน Held-out Test Split (n=120 ภาพ, 941 หลัก) ได้ Exact Reading Accuracy 67.5% [58.7%, 75.2%], Digit-level Accuracy 90.44% [88.4%, 92.2%], DER 7.33% และบนชุดสาธิตภาคสนาม (n=7) ได้ 100.0% [64.6%, 100.0%] (หัวข้อ 3.4.3 และ 3.4.5) |
| 12 hypotheses ช่วยให้แม่นขึ้น | Ablation: `single-pass` vs `12-hypothesis` วัด Exact Reading Accuracy เดียวกัน | **พิสูจน์แล้ว (Supported)** — ผลการตัดทอน 9 ขั้นตอน ขั้นตอน M0 (42.9%) ก้าวหน้าสู่ M1 (57.1%) และ M2 (71.4%) ในหัวข้อ 3.4.6 ยืนยันว่าการขยายสมมติฐานช่วยเพิ่มความแม่นยำอย่างต่อเนื่อง |
...
#### 3.4.4 ตารางสรุปข้ออ้างและหลักฐาน
...
| YOLO เป็น Single-stage/Anchor-free ตามเอกสาร | External | Ultralytics (2026) | Supported (external doc) |
| SigLIP2 ใช้ Pairwise Sigmoid Loss | External | Zhai et al. (2023); Tschannen et al. (2025) | Supported (external papers) |
| 12 hypotheses ช่วยให้ความแม่นยำสูงกว่า Single-pass | Empirical | ผลทดลอง Progressive Ablation: M0 (42.9%) vs M2 (71.4%) vs M4 (100.0%) (ดูตารางที่ 3.8 ในหัวข้อ 3.4.6) | Supported |
| Safety Guards ช่วยยกระดับความแม่นยำ | Empirical | M3 (`is_vertical`) เพิ่มความแม่นยำ +14.3%, M4 (`red_ratio`) เพิ่มความแม่นยำ +14.3% (ดูตารางที่ 3.8 ในหัวข้อ 3.4.6) | Supported |
| YOLO26m มีประสิทธิภาพการตรวจจับสูงบนชุดทดสอบ | Empirical | Precision, Recall, mAP@50, mAP@50-95 บนชุดทดสอบอิสระ 194 ภาพ (ดูตารางที่ 3.9 ในหัวข้อ 3.4.8) | Supported |
...
#### 3.4.5 การประเมินแบบ End-to-End และโปรโตคอลทำซ้ำได้

&emsp;&emsp;&emsp;&emsp;การประเมินระบบทั้งท่อประมวลผล (End-to-End) ใช้ชุดทดสอบสาธิต `meter_img/` จำนวน 7 ภาพ พร้อมไฟล์ความจริงภาคพื้น `meter_img/ground_truth.csv` (คอลัมน์ `file,reading`) ที่ผ่านการตรวจทานด้วยตามนุษย์อย่างละเอียด ผลลัพธ์จากการรัน `uv run python validate.py --dir meter_img` (CPU AMD Ryzen 5, `YOLO_IMGSZ=960`, 12 สมมติฐาน) ได้ผลการอ่านถูกต้องสมบูรณ์บนชุดสาธิตเบื้องต้น (7/7 ภาพ หรือ 100.0% บน Demo Set n=7) โดยมี Digit-level Accuracy เท่ากับ 100.0% (36/36 หลัก), Digit Error Rate (DER) เท่ากับ 0.0%, ค่าความเชื่อมั่นเฉลี่ยของแบบจำลอง (Mean Confidence) เท่ากับ 0.861, และผ่านการยืนยันประเภทมาตรวัดน้ำ (Meter Verified) 7/7 ภาพ บันทึกผลลัพธ์ใน `reviews/validation_results.json` และ `reviews/validation_results.csv` พร้อมเวลาประมวลผลรายภาพดังแสดงในตารางที่ 3.7
...
|---|---|---|---|---|---|---|
| meter_sample_01.jpg | 33858 | 33858 | ถูกต้อง | 0.816 | 90°/orig | 37397 |
| meter_sample_02.jpg | 01628 | 01628 | ถูกต้อง | 0.891 | 0°/histeq | 5678 |
| meter_sample_03.jpg | 43920 | 43920 | ถูกต้อง | 0.821 | 0°/histeq | 5979 |
| meter_sample_04.jpg | 023814 | 023814 | ถูกต้อง | 0.884 | 270°/orig | 6170 |
| meter_sample_05.jpg | 01882 | 01882 | ถูกต้อง | 0.890 | 270°/histeq | 5955 |
| meter_sample_06.jpg | 33858 | 33858 | ถูกต้อง | 0.851 | 0°/clahe | 5332 |
| meter_sample_07.jpg | 05715 | 05715 | ถูกต้อง | 0.873 | 0°/orig | 5828 |
...
2. `Digit-level Accuracy` = สัดส่วนหลักที่ถูกต้องต่อจำนวนหลักทั้งหมดในชุดทดสอบ (36/36 หลัก หรือ 100.0%)
...
> 3. **สถาปัตยกรรมเชิงป้องกันความผิดพลาด (Defensive Engineering):** แม้ระบบจะไม่สามารถการันตีความถูกต้อง 100% บนภาพที่ 8 แต่สถาปัตยกรรมที่ออกแบบไว้มีกลไกรับมือความล้มเหลวอย่างรัดกุม โดยหากภาพที่ 8 ตรวจพบตัวเลขที่มีค่าความเชื่อมั่นต่ำกว่าเกณฑ์ (`confidence < 0.60`) หรือตัวเลขเรียงตัวผิดระนาบ ระบบจะไม่ฝืนเดาค่าตัวเลข แต่จะส่งคืนแถบคำเตือน (`warnings`) พร้อมปรับสถานะ `verified = False` เพื่อแจ้งเตือนให้เจ้าหน้าที่ภาคสนามตรวจสอบยืนยันด้วยสายตามนุษย์
...
#### 3.4.6 ผลการศึกษาเชิงตัดทอนแบบก้าวหน้า 9 ขั้นตอน
...
<p align="center"><strong>ตารางที่ 3.8: ผลการศึกษาเชิงตัดทอนแบบก้าวหน้า 9 ขั้นตอน (9-Stage Progressive Ablation Benchmark)</strong></p>
...
| **M4** | **+ Red Digit Ratio Bonus (`red_ratio` & `score_reading`)** | 100.0% [64.6%, 100.0%] | **100.0% [64.6%, 100.0%]** | 7/7 | 0.861 | 4,952.6 ms | **Exact Reading Accuracy เพิ่มขึ้นเป็น 100.0% (7/7) บนชุดสาธิตภาคสนามที่ใช้ในการทดลองนี้** แยกแยะหลักทศนิยมสีแดง ป้องกันการสับสนระหว่างหัว-ท้าย |
...
| **M8** | **+ Dial Text & Unit 'm' Alignment (`detect_dial_text_orientation`)** | 100.0% [64.6%, 100.0%] | **100.0% [64.6%, 100.0%]** | 7/7 | 0.861 | 5,845.2 ms | **ช่วยลดความเสี่ยงจากภาพที่มีการหมุน 90°/270° บนชุดข้อมูลที่ใช้ในการทดลอง** ตรวจจับทิศทางสัญลักษณ์ m และข้อความบนหน้าปัดเพื่อจัดระนาบแนวนอนอัตโนมัติ ป้องกันการอ่านกลับหัวของตัวเลขสมมาตร |
...
4. การคำนวณโบนัสตัวเลขสีแดง (เปรียบเทียบ M3 กับ M4: Red Digit Ratio Bonus - `red_ratio`):
   ...
   3) *What for (วัตถุประสงค์ในระบบ):* ยกระดับ Exact Reading Accuracy บรรลุ 100.0% (7/7) บนชุดสาธิต โดยช่วยให้อ่านค่าภาพ `meter_sample_03.jpg` ที่มีหลักทศนิยมสีแดงได้อย่างถูกต้องครบถ้วน
...
5. กลไกความปลอดภัยและความคงสภาพข้อมูล (เปรียบเทียบ M5 กับ M7: Safety & Verification Guards):
   ...
   3) *What for (วัตถุประสงค์ในระบบ):* รักษาระดับ Exact Reading Accuracy ไว้ที่ 100.0% บนชุดสาธิต พร้อมทั้งส่งคืนค่าสถานะการตรวจทาน (`verified: True/False`) และแถบคำเตือน (`warnings`) เพื่อส่งต่อให้เจ้าหน้าที่ตรวจสอบกรณีตัวเลขมีค่าความเชื่อมั่นต่ำกว่าเกณฑ์
...
##### 3.4.7.1 โปรโตคอลการวัดเวลาและการจำแนกสภาวะการทดสอบ

&emsp;&emsp;&emsp;&emsp;เพื่อป้องกันความสับสนระหว่างตัวเลขเวลาประมวลผลเฉลี่ยที่ปรากฏในเอกสาร (ได้แก่ 10.3 วินาที, 8.3 วินาที, และ 5.8 วินาทีต่อภาพ) โครงงานได้กำหนดและจำแนกโปรโตคอลการวัดเวลาออกเป็น 3 สภาวะอย่างโปร่งใสดังนี้:

###### 3.4.7.1.1 โปรโตคอล ก (Initial Run with Cold-start Overhead — เฉลี่ย 10.3 วินาทีต่อภาพ)

&emsp;&emsp;&emsp;&emsp;1) *ค่าที่วัดได้จริง:* เวลารวมทั้ง 7 ภาพเท่ากับ 72,339 มิลลิวินาที ส่งผลให้เวลาเฉลี่ยเท่ากับ 10,334 ms (10.33 วินาทีต่อภาพ) ตามข้อมูลดิบในตารางที่ 3.7<br>
&emsp;&emsp;&emsp;&emsp;2) *สาเหตุทางเทคนิค:* ภาพแรกสุดของการรัน (`meter_sample_01.jpg`) บันทึกเวลาสูงถึง 37,397 ms (37.4 วินาที) เนื่องจากระบบมีภาระงาน Overhead ในการจัดสรรหน่วยความจำครั้งแรกของไดรเวอร์ซีพียูและเคอร์เนล PyTorch (First-inference allocation spike) ร่วมกับภาพดังกล่าวต้องหมุน 90 องศา เมื่อนำมารวมกับภาพที่เหลือ จึงดึงค่าเฉลี่ยของทั้งชุดขึ้นเป็น 10.3 วินาที

###### 3.4.7.1.2 โปรโตคอล ข (Repeated Benchmark Run — เฉลี่ย 8.3 วินาทีต่อภาพ)

&emsp;&emsp;&emsp;&emsp;1) *ค่าที่วัดได้จริง:* ค่าเฉลี่ย 8.34 วินาทีต่อภาพ (ช่วงเวลาต่ำสุด 4.9 วินาที, เฉลี่ย 8.3 วินาที, สูงสุด 26.7 วินาที) ตามที่รายงานในตารางที่ 3.2<br>
...
###### 3.4.7.1.3 โปรโตคอล ค (Steady-State Warm Run / Controlled Ablation — เฉลี่ย 5.8 วินาทีต่อภาพ)

&emsp;&emsp;&emsp;&emsp;1) *ค่าที่วัดได้จริง:* ค่าเฉลี่ย 5,828.8 ms (ประมาณ 5.8 วินาทีต่อภาพ) ในขั้นตอน M7 ของตารางที่ 3.8 และสอดคล้องตรงกันกับค่าเฉลี่ยเฉพาะภาพที่ 2 ถึง 7 ของตารางที่ 3.7 (34,942 ms / 6 ภาพ = 5,823.7 ms หรือ 5.82 วินาทีต่อภาพ)<br>
...
##### 3.4.7.2 การจำแนกสัดส่วนเวลาการประมวลผลภายในระบบ
...
##### 3.4.7.3 แนวทางการปรับปรุงความเร็วในระดับอุตสาหกรรม
...
#### 3.4.8 ผลการประเมินประสิทธิภาพตัวตรวจจับวัตถุระดับคลาสและตัวชี้วัดสากล
...
4. ความแตกต่างระหว่าง mAP@50 (87.86%) และ mAP@50:95 (47.71%): เนื่องจากตัวเลขบนหน้าปัดมาตรวัดน้ำมีขนาดเล็กเมื่อเทียบกับขนาดภาพทั้งหมด (Small Object Footprint) การคลาดเคลื่อนของขอบกรอบสี่เหลี่ยมเพียง 1–2 พิกเซลส่งผลกระทบอย่างมากต่อเกณฑ์ $IoU \ge 0.75-0.95$ อย่างไรก็ดี ในการศึกษานี้ ค่า IoU ที่ระดับ 0.50 ถูกใช้เป็นเกณฑ์หนึ่งในการประเมินตำแหน่งกรอบตรวจจับ เนื่องจากการจัดเรียงตัวเลขของระบบอาศัยตำแหน่งเชิงสัมพัทธ์ของกรอบตรวจจับเป็นหลัก

---

#### 3.4.9 การวิเคราะห์ข้อผิดพลาดและมาตรการป้องกันเชิงวิศวกรรม
...
#### 3.4.10 การวิเคราะห์ความไม่แน่นอนทางสถิติและการตอบคำถามการวิจัย
...
&emsp;&emsp;&emsp;&emsp;ดังนั้น โครงงานนี้จึงกำหนดข้อสรุปอย่างระมัดระวัง โดยระบุว่าความแม่นยำ 100.0% เป็นผลการทำงานเฉพาะบนชุดตัวอย่างสาธิต $N=7$ เท่านั้น และนำผลการประเมินประสิทธิภาพตัวตรวจจับวัตถุบนชุดทดสอบที่กันออกจากการฝึก $N=194$ (ตารางที่ 3.9) มาเป็นหลักฐานสนับสนุนความสามารถในการตรวจจับร่วมด้วย
...
| **RQ2: Multi-hypothesis Search**<br>การค้นหา 12 รูปแบบช่วยเพิ่มความแม่นยำอย่างไร? | การทดลองแบบก้าวหน้า (Ablation เปรียบเทียบจาก M0 ถึง M2) บนชุดทดสอบสาธิต | Exact Accuracy เพิ่มขึ้นจาก 42.9% (M0) เป็น 71.4% (M2) เพิ่มขึ้น +28.5% | การหมุน 4 ทิศทางร่วมกับการปรับคอนทราสต์ 3 รูปแบบช่วยกู้คืนภาพที่ถ่ายเอียงและภาพที่มีคราบสกปรกในการทดลอง |
| **RQ3: Geometric Guards & Rules**<br>กลไกความปลอดภัยและสีแดงป้องกันข้อผิดพลาดได้จริงหรือไม่? | การทดลองแบบก้าวหน้า (Ablation เปรียบเทียบจาก M2 ถึง M5) | Exact Accuracy เพิ่มขึ้นจาก 71.4% (M2) สู่ 100.0% (M4/M5) | ในการทดลอง Progressive Ablation ชุดสาธิต การเพิ่ม is_vertical และ red_ratio สัมพันธ์กับการเพิ่ม Exact Reading Accuracy จาก 71.4% เป็น 100.0% โดยผลดังกล่าวจำกัดอยู่ภายในชุดข้อมูลที่ใช้ทดลอง |
| **RQ4: Zero-shot Gatekeeper**<br>SigLIP2 คัดกรองภาพที่ไม่ใช่มิเตอร์ได้โดยไม่ต้องเทรนใหม่หรือไม่? | การทดสอบ Zero-shot ด้วยแบบจำลอง SigLIP2 ผ่านเกณฑ์ความเชื่อมั่น 0.50 | จำแนกภาพมิเตอร์น้ำได้ถูกต้องครบ 7 ภาพตัวอย่าง พร้อมปฏิเสธภาพสิ่งแปลกปลอม (Zero-shot Accuracy 100% บนชุดสาธิต) | ผลการทดลองบนชุดสาธิตแสดงให้เห็นว่า SigLIP2 สามารถทำหน้าที่เป็นตัวคัดกรองข้อมูลนำเข้าได้ในเงื่อนไขการทดสอบของโครงงาน โดยได้ผล 7/7 ภาพ อย่างไรก็ตาม ยังจำเป็นต้องประเมินบนชุดข้อมูลที่มีขนาดและความหลากหลายมากขึ้น |
| **RQ5: Latency-Accuracy Trade-off**<br>ความแม่นยำที่เพิ่มขึ้นแลกกับเวลาประมวลผลเท่าใด? | การวัดเวลาประมวลผลเชิงลึก (Latency Profiling) บน CPU AMD Ryzen 5 | M0 ใช้เวลา 421.1 ms (42.9%) ขยายเป็น 5,828.8 ms ใน M7 (100.0%) | ผลดังกล่าวแสดงถึง trade-off ระหว่างความแม่นยำและเวลาในการประมวลผล โดยการประยุกต์ใช้ multi-angle inference ทำให้เวลาเพิ่มขึ้นเมื่อเทียบกับ baseline |
...
3.5.1 สิทธิ์การใช้งาน (License): YOLO (Ultralytics) ใช้ AGPL-3.0 สำหรับงาน Open Source หรือต้องซื้อ Commercial License สำหรับงานเชิงพาณิชย์, SigLIP2 ใช้ Apache 2.0<br>
3.5.2 ความเป็นส่วนตัวของข้อมูล (PDPA): ภาพมิเตอร์อาจติดข้อมูลบ้านเรือน ควรกำหนดให้ลบไฟล์ชั่วคราวทันทีหลังประมวลผลเสร็จ<br>
3.5.3 การเร่งความเร็วด้วย GPU และการประมวลผลระดับอุตสาหกรรม: ระบบได้รับการวัดเวลาการทำงานอย่างเป็นทางการบนซีพียู AMD Ryzen 5 8645HS ที่ความละเอียด 960x960 ใช้เวลาเฉลี่ย 533.2 ms ในโหมดสมมติฐานเดี่ยว และ 5,828.8 ms ในโหมด 12 สมมติฐานเต็มรูปแบบ สำหรับการขยายผลสู่ระดับอุตสาหกรรมที่ต้องรองรับภาพถ่ายปริมาณมาก การประมวลผลด้วย GPU และการแปลงแบบจำลองเป็น TensorRT FP16 เป็นแนวทางที่ควรพิจารณาสำหรับการลดเวลาในการประมวลผล อย่างไรก็ตาม ค่าประสิทธิภาพดังกล่าวขึ้นอยู่กับฮาร์ดแวร์ รุ่นแบบจำลอง และการตั้งค่าการอนุมาน จึงควรมีการ benchmark แยกก่อนนำไปใช้งานจริง
...
4.1.1 ประสิทธิภาพของแบบจำลองตรวจจับตัวเลข (Object Detection Performance): พัฒนาขึ้นโดยใช้สถาปัตยกรรม Functional Modular Design ที่บูรณาการแบบจำลอง YOLO26m สำหรับการตรวจจับตัวเลขแต่ละหลัก (Class 0–9) โดยจากการประเมินแบบจำลองบนชุดทดสอบจาก Roboflow จำนวน 194 ภาพ ซึ่งมีตัวอย่างตัวเลข 1,508 หลัก แบบจำลองมีค่า Precision 93.53%, Recall 89.30%, F1-Score 91.37%, mAP@50 87.86% และ mAP@50:95 47.71% (ตามตารางที่ 3.9) ขณะที่การประเมินผลการทำงานของระบบอ่านค่าแบบครบวงจร (End-to-End Pipeline) ดำเนินการบนชุดทดสอบที่กันออกจากการฝึก (Held-out Test Split) จำนวน 120 ภาพ (941 ตัวอย่างตัวเลข) ซึ่งรายงานผลไว้ในหัวข้อ 3.4.3 (Exact Reading Accuracy 67.50% หรือ 81/120 ภาพ และ Digit Accuracy 90.44% หรือ 851/941 ตัวเลข)<br>
4.1.2 ชุดกระบวนการเสริมความคงทนต่อสภาพแวดล้อม (Ablation Progression): จากการทดสอบแบบ Progressive 9-Stage Ablation Study บนชุดภาพสาธิต (ตามตารางที่ 3.8) พบว่าการเสริมองค์ประกอบช่วยเพิ่ม Exact Reading Accuracy ในชุดภาพสาธิตที่ใช้ในการศึกษา:

&emsp;&emsp;&emsp;&emsp;4.1.2.1 แบบจำลองพื้นฐาน (Baseline Single-pass 0°): มีความแม่นยำเพียง 42.86% (ช่วงความเชื่อมั่น 95% Wilson Score CI: $[15.82\%, 74.95\%]$)<br>
&emsp;&emsp;&emsp;&emsp;4.1.2.2 การเพิ่มการหมุนภาพ 4 ทิศทาง (Multi-angle Rotation): ยกระดับความแม่นยำเป็น 57.14% ($+14.28\%$)<br>
&emsp;&emsp;&emsp;&emsp;4.1.2.3 การเพิ่มการปรับคอนทราสต์แสง (Multi-contrast 12 สมมติฐาน): ยกระดับขึ้นเป็น 71.43% ($+14.29\%$)<br>
&emsp;&emsp;&emsp;&emsp;4.1.2.4 การเสริมการกรองเชิงเรขาคณิตและสี (Geometric & Color Bonus): เสริม `is_vertical` และ `red_ratio` ทำให้ระบบตรวจจับและแยกตัวเลขได้ครบถ้วน โดย Exact Reading Accuracy เพิ่มขึ้นเป็น 100.00% (7/7 ภาพ; Wilson 95% CI: $[64.57\%, 100.00\%]$)<br>
&emsp;&emsp;&emsp;&emsp;4.1.2.5 กลไกความปลอดภัยและการตรวจทาน (Safety Guards & SigLIP2): Flip Guard, Cross-check และ SigLIP2 เพิ่มกลไกสำหรับตรวจสอบผลลัพธ์และจัดการกรณีที่มีความไม่แน่นอน โดยผลการทดลองบนชุดสาธิตไม่พบการลดลงของ Exact Reading Accuracy<br>
4.1.3 บริการส่วนเชื่อมต่อโปรแกรมประยุกต์และส่วนติดต่อผู้ใช้: พัฒนา REST API ด้วย FastAPI พร้อม Interactive Swagger UI และ Gradio Web Application โดยมีเวลาประมวลผลเฉลี่ย 5,828.8 มิลลิวินาทีต่อภาพบนหน่วยประมวลผลกลาง AMD Ryzen 5 สำหรับการค้นหาเชิงครอบคลุม 12 สมมติฐาน (ตามตารางที่ 3.8)
...
4.2.1 ประสิทธิผลของการค้นหา 12 สมมติฐานและการประมวลผลภาพ (ตอบ RQ2): ผลการทดลองแสดงให้เห็นว่าการค้นหาเชิงครอบคลุม (4 ทิศทาง × 3 การปรับแสง) ช่วยเพิ่ม Exact Reading Accuracy จาก 42.86% ใน Single-pass Baseline สู่ 71.43% ในระยะ M2 บนชุดภาพสาธิต อย่างไรก็ตาม ผลการทดลองชี้ให้เห็นชัดเจนถึงข้อแลกเปลี่ยน (Trade-off) ด้านเวลา โดย Latency เพิ่มขึ้นจาก 421.1 ms เป็น 5,492.6 ms บน CPU เนื่องจากต้องรัน Inference ซ้ำ 12 ครั้ง<br>
4.2.2 บทบาทของเรขาคณิตและการตรวจจับสีแดง (ตอบ RQ3): ในการทดลองแบบ Progressive Ablation บนชุดสาธิต 7 ภาพ การเพิ่ม is_vertical และ red_ratio ทำให้ Exact Reading Accuracy เพิ่มจาก 71.43% เป็น 100.00% ตามลำดับขั้นของการทดลอง อย่างไรก็ตาม ผลดังกล่าวเป็นผลเฉพาะชุดสาธิตและไม่ควรตีความเป็นประสิทธิผลทั่วไปของ heuristics ดังกล่าว โดยสะท้อนว่าในโดเมนที่มีโครงสร้างเฉพาะ เช่น มาตรวัดน้ำ การใช้ฮิวริสติกส์เฉพาะโดเมน (Domain-specific Heuristics) ร่วมกับการเรียนรู้เชิงลึกสามารถเสริมประสิทธิภาพของแบบจำลองตรวจจับได้อย่างมีประสิทธิผล<br>
4.2.3 การทำงานร่วมกับ SigLIP2 และความคงทนของระบบ (ตอบ RQ1 และ RQ4): การใช้ SigLIP2 ในด่านคัดกรองเบื้องต้นและการตรวจทานผลช่วยเพิ่มขั้นตอนการตรวจสอบความสอดคล้องของผลลัพธ์ในระดับระบบ โดยในการทดลองชุดสาธิตพบ Zero-shot Verification Rate 100% (7/7) และใช้เวลาเพิ่มเติมเฉลี่ย $164.1$ ms ในขั้นตอนการตรวจทาน<br>
...
4.3.1 ขนาดของชุดประเมินผลลัพธ์ End-to-End ($N=7$ ภาพ): แม้แบบจำลอง YOLO26m จะได้รับการประเมินบนชุดทดสอบที่กันออกจากการฝึก (Held-out Test Split) จากชุดข้อมูลที่จัดการผ่าน Roboflow จำนวน 194 ภาพ (1,508 ตัวเลข) แต่ชุดการประเมินระบบแบบบูรณาการทั้งระบบ (End-to-End Pipeline) ในชุดสาธิตยังมีขนาดจำกัด ($N=7$) ส่งผลให้ช่วงความเชื่อมั่นทางสถิติของ Exact Accuracy ยังมีขอบเขตค่อนข้างกว้าง ($[64.57\%, 100.00\%]$) ซึ่งในทางระเบียบวิธีวิจัยควรถือเป็นชุดตรวจสอบการทำงานเบื้องต้น (Sanity Check / Demonstration Set) และจำเป็นต้องขยายผลการทดสอบสู่ชุดภาพภาคสนามที่มีจำนวนและความหลากหลายเพียงพอสำหรับการประเมิน General Accuracy ในการวิจัยระยะถัดไป<br>
4.3.2 ความเสี่ยงจากข้อผิดพลาดเฉพาะกรณี (Failure Taxonomy): จากการวิเคราะห์ตามตารางที่ 3.10 ระบบยังมีความเสี่ยงต่อความผิดพลาดบางรูปแบบ ได้แก่ ความสับสนระหว่างตัวเลขคล้ายกัน (เช่น 6 สับสนกับ 8 หรือ 3 สับสนกับ 8 ในกรณีแสงเงาตกกระทบ), การตกหล่นของตัวเลขในกรณีคราบน้ำบดบัง, และกรอบข้อความบริเวณรอบนอกหน้าปัด<br>
4.3.3 ข้อจำกัดด้านความเร็วในการประมวลผลบนหน่วยประมวลผลกลาง (CPU Latency): การประมวลผลค้นหาครอบคลุม 12 สมมติฐานใช้เวลาเฉลี่ยประมาณ $5.8$ วินาทีต่อภาพบน CPU ซึ่งมีลักษณะการตอบสนองที่เหมาะกับการประมวลผลแบบไม่ต่อเนื่องหรือเป็นชุด มากกว่าการประมวลผลวิดีโอแบบเวลาจริง<br>
...
4.4.1 การขยายขอบเขตไปยังมาตรวัดน้ำรูปแบบอื่น: พัฒนาและฝึกฝนแบบจำลองเพิ่มเติมสำหรับตรวจจับและอ่านค่ามาตรวัดน้ำแบบเข็มหมุน (Circular Dial Meter) และหน้าปัดดิจิทัลแบบ LCD เพื่อให้ครอบคลุมประเภทของมาตรวัดน้ำที่ใช้งานในประเทศทั้งหมด<br>
...
4.4.4 การขยายขนาดชุดข้อมูลทดสอบ End-to-End: เพื่อลดความกว้างของช่วงความเชื่อมั่นทางสถิติ (Wilson Score 95% Confidence Interval) และยกระดับความน่าเชื่อถือของการประเมินผลเชิงประจักษ์ ควรรวบรวมชุดข้อมูลทดสอบที่มีจำนวนและความหลากหลายเพียงพอสำหรับการประเมิน General Accuracy โดยกำหนดขนาดตัวอย่างตามระดับความเชื่อมั่นและค่าความคลาดเคลื่อนที่ยอมรับได้
