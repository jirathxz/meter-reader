...
&emsp;&emsp;&emsp;&emsp;1.2.1 ใช้แบบจำลอง YOLO26 สำหรับตรวจจับและระบุตัวเลข 0–9 บนหน้าปัดมาตรวัดน้ำโดยตรงจากภาพเต็ม โดยไม่ต้องตัดภาพล่วงหน้า ซึ่งเป็นอีกแนวทางหนึ่งที่ลดความจำเป็นในการตัดภาพตัวเลขล่วงหน้า เมื่อเปรียบเทียบกับ pipeline บางประเภทที่แยกขั้นตอนการตรวจจับบริเวณตัวเลขและการรู้จำออกจากกัน
...
2. ชุดข้อมูลภาพสาธิตภาคสนาม (Field Demonstration Set, n=7 ภาพ): ทดสอบความคงทนต่อการติดตั้งเอียง คราบสิ่งสกปรก แสงสะท้อน และประเมินคุณูปการส่วนเพิ่มของแต่ละโมดูลผ่านการศึกษาเชิงตัดทอนแบบก้าวหน้า (8-Stage Progressive Ablation Study)

<p align="center"><strong>ตารางที่ 3.2: ผลการประเมินประสิทธิภาพระบบอ่านค่ามาตรวัดน้ำบนชุดทดสอบมาตรฐานและชุดสาธิตภาคสนาม</strong></p>

| ตัวชี้วัดประสิทธิภาพ (Metric) | ชุดทดสอบมาตรฐาน (Test Split, n=120) | ชุดสาธิตภาคสนาม (Demo Set, n=7) | นิยามทางคณิตศาสตร์และขอบเขตการวัด |
|---|:---:|:---:|---|
...
| อ่านค่ามิเตอร์ถูกครบทุกหลัก | วัด Exact Reading Accuracy / Digit-level Accuracy บน test set ที่มี ground-truth reading | **พิสูจน์แล้วบนชุดข้อมูลทดสอบมาตรฐาน (Supported on Test Split)** — วัดผลจริงบน Held-out Test Split (n=120 ภาพ, 941 หลัก) ได้ Exact Reading Accuracy 67.5% [58.7%, 75.2%], Digit-level Accuracy 90.44% [88.4%, 92.2%], DER 7.33% และบนชุดสาธิตภาคสนาม (n=7) ได้ 100.0% [64.6%, 100.0%] (หัวข้อ 3.4.3 และ 3.4.5) |
...
| **M4** | **+ Red Digit Ratio Bonus (`red_ratio` & `score_reading`)** | 100.0% [64.6%, 100.0%] | **100.0% [64.6%, 100.0%]** | 7/7 | 0.861 | 4,952.6 ms | **Exact Reading Accuracy เพิ่มขึ้นเป็น 100.0% (7/7) บนชุดสาธิตที่ใช้ในการทดลองนี้** แยกแยะหลักทศนิยมสีแดง ป้องกันการสับสนระหว่างหัว-ท้าย |
...
&emsp;&emsp;&emsp;&emsp;สำหรับการติดตั้งใช้งานจริงในระดับอุตสาหกรรม หากประมวลผลบนการ์ดจอแยกที่มีการประมวลผลแบบขนานด้วย CUDA และแปลงแบบจำลองเป็น TensorRT (FP16) เวลาประมวลผลของ 12 สมมติฐานจะสามารถลดลงเหลือต่ำกว่า ~150–250 ms ต่อภาพได้อย่างชัดเจน
